...
var file_proto_service_developer_flink_developer_proto_rawDesc = []byte{
	...
	0x32, 0x88, 0x03, 0x0a, 0x0e, 0x46, 0x6c, 0x69, 0x6e, 0x6b, 0x44, 0x65, 0x76, 0x65, 0x6c, 0x6f,
	...
	,
	...
	0x76, 0x63, 0x64, 0x65, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x72, 0x42, 0x13, 0x50, 0x42, 0x53,
	0x76, 0x63, 0x46, 0x6c, 0x69, 0x6e, 0x6b, 0x44, 0x65, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x72,
...
var file_proto_service_developer_flink_developer_proto_goTypes = []interface{}{
	...
	(*pbresponse.GetFlinkJobStatus)(nil), // 5: response.GetFlinkJobStatus
	(*pbmodel.EmptyStruct)(nil),          // 6: model.EmptyStruct
	(*pbresponse.ValidateFlinkJob)(nil),  // 7: response.ValidateFlinkJob
	(*pbresponse.ExecuteFlinkSql)(nil),   // 8: response.ExecuteFlinkSql
}
var file_proto_service_developer_flink_developer_proto_depIdxs = []int32{
	...
	0, // 3: developer.FlinkDeveloper.ValidateFlinkJobContext:input_type -> request.SubmitFlinkJob
	3, // 4: developer.FlinkDeveloper.ExecuteFlinkSql:input_type -> request.ExecuteFlinkSql
	4, // 5: developer.FlinkDeveloper.SubmitFlinkJob:output_type -> response.SubmitFlinkJob
	5, // 6: developer.FlinkDeveloper.GetFlinkJobStatus:output_type -> response.GetFlinkJobStatus
	6, // 7: developer.FlinkDeveloper.CancelFlinkJob:output_type -> model.EmptyStruct
	7, // 8: developer.FlinkDeveloper.ValidateFlinkJobContext:output_type -> response.ValidateFlinkJob
	8, // 9: developer.FlinkDeveloper.ExecuteFlinkSql:output_type -> response.ExecuteFlinkSql
