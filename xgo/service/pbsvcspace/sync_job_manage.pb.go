...
var file_proto_service_spacemanager_sync_job_manage_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xb7, 0x0c, 0x0a, 0x0d, 0x53, 0x79, 0x6e, 0x63, 0x4a,
...
var file_proto_service_spacemanager_sync_job_manage_proto_goTypes = []interface{}{
	...
	(*pbresponse.GenerateJobJson)(nil),           // 26: response.GenerateJobJson
	(*pbresponse.ConvertSyncJobMode)(nil),        // 27: response.ConvertSyncJobMode
}
var file_proto_service_spacemanager_sync_job_manage_proto_depIdxs = []int32{
	...
	19, // 33: spacemanager.SyncJobManage.ReopenReleaseSyncJob:output_type -> model.EmptyStruct
	24, // 34: spacemanager.SyncJobManage.ListReleaseSyncJobs:output_type -> response.ListReleaseSyncJobs
	19, // 35: spacemanager.SyncJobManage.UpdateReleaseSyncJobStatus:output_type -> model.EmptyStruct
	...
	26, // 40: spacemanager.SyncJobManage.GenerateJobJson:output_type -> response.GenerateJobJson
	27, // 41: spacemanager.SyncJobManage.ConvertSyncJobMode:output_type -> response.ConvertSyncJobMode
