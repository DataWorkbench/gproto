...
type TableColumn struct {
	...
	IsPrimaryKey bool `protobuf:"varint,3,opt,name=is_primary_key,json=isPrimaryKey,proto3" json:"is_primary_key" gorm:"column:is_primary_key;"`
}
...
func (x *TableColumn) GetIsPrimaryKey() bool {
	if x != nil {
...
type TableColumnForDataService struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	ColumnType   string `protobuf:"bytes,2,opt,name=column_type,json=columnType,proto3" json:"column_type"`
	IsPrimaryKey bool   `protobuf:"varint,3,opt,name=is_primary_key,json=isPrimaryKey,proto3" json:"is_primary_key"`
	ParamType    string `protobuf:"bytes,4,opt,name=param_type,json=paramType,proto3" json:"param_type"`
}

func (x *TableColumnForDataService) Reset() {
	*x = TableColumnForDataService{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_types_model_datasource_datasource_table_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *TableColumnForDataService) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TableColumnForDataService) ProtoMessage() {}

func (x *TableColumnForDataService) ProtoReflect() protoreflect.Message {
	mi := &file_proto_types_model_datasource_datasource_table_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TableColumnForDataService.ProtoReflect.Descriptor instead.
func (*TableColumnForDataService) Descriptor() ([]byte, []int) {
	return file_proto_types_model_datasource_datasource_table_proto_rawDescGZIP(), []int{2}
}

func (x *TableColumnForDataService) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *TableColumnForDataService) GetColumnType() string {
	if x != nil {
		return x.ColumnType
	}
	return ""
...
func (x *TableColumnForDataService) GetIsPrimaryKey() bool {
	if x != nil {
		return x.IsPrimaryKey
	}
	return false
...
func (x *TableColumnForDataService) GetParamType() string {
	if x != nil {
		return x.ParamType
	}
	return ""
...
var file_proto_types_model_datasource_datasource_table_proto_rawDesc = []byte{
	...
	0x6d, 0x6e, 0x73, 0x22, 0x5b, 0x0a, 0x0b, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x43, 0x6f, 0x6c, 0x75,
	...
	,
...
var file_proto_types_model_datasource_datasource_table_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_types_model_datasource_datasource_table_proto_goTypes = []interface{}{
	...
	(*TableColumnForDataService)(nil), // 2: datasource.TableColumnForDataService
}
...
func file_proto_types_model_datasource_datasource_table_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_types_model_datasource_datasource_table_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TableColumnForDataService); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
