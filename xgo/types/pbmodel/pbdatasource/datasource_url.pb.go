...
type ElasticSearchURL_Version int32

const (
	ElasticSearchURL_VersionUnset ElasticSearchURL_Version = 0
	ElasticSearchURL_es_6         ElasticSearchURL_Version = 1
	ElasticSearchURL_es_7         ElasticSearchURL_Version = 2
)

// Enum value maps for ElasticSearchURL_Version.
var (
	ElasticSearchURL_Version_name = map[int32]string{
		0: "VersionUnset",
		1: "es_6",
		2: "es_7",
	}
	ElasticSearchURL_Version_value = map[string]int32{
		"VersionUnset": 0,
		"es_6":         1,
		"es_7":         2,
	}
...
func (x ElasticSearchURL_Version) Enum() *ElasticSearchURL_Version {
	p := new(ElasticSearchURL_Version)
	*p = x
	return p
}

func (x ElasticSearchURL_Version) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ElasticSearchURL_Version) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_types_model_datasource_datasource_url_proto_enumTypes[2].Descriptor()
}

func (ElasticSearchURL_Version) Type() protoreflect.EnumType {
	return &file_proto_types_model_datasource_datasource_url_proto_enumTypes[2]
}

func (x ElasticSearchURL_Version) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ElasticSearchURL_Version.Descriptor instead.
func (ElasticSearchURL_Version) EnumDescriptor() ([]byte, []int) {
	return file_proto_types_model_datasource_datasource_url_proto_rawDescGZIP(), []int{14, 0}
}
...
type ElasticSearchURL struct {
	...
	Password string `protobuf:"bytes,4,opt,name=password,proto3" json:"password"`
	// Password specifies the password of db. Is Required. Length Min: 1, Length Max: 64.
	Version ElasticSearchURL_Version `protobuf:"varint,5,opt,name=version,proto3,enum=datasource.ElasticSearchURL_Version" json:"version"`
}
...
func (x *ElasticSearchURL) GetVersion() ElasticSearchURL_Version {
	if x != nil {
		return x.Version
	}
	return ElasticSearchURL_VersionUnset
}
...
type RedisURL struct {
	...
	// Port specifies the port of db. Is Required. Min: 0, Length Max: 65536.
	RedisHosts []*Host `protobuf:"bytes,1,rep,name=redis_hosts,json=redisHosts,proto3" json:"port"`
	// Password specifies the password of db. Is Required. Length Min: 1, Length Max: 64.
...
func (x *RedisURL) GetRedisHosts() []*Host {
	if x != nil {
		return x.RedisHosts
	}
	return nil
...
var file_proto_types_model_datasource_datasource_url_proto_rawDesc = []byte{
	...
	0x46, 0x53, 0x3a, 0x06, 0xca, 0xb2, 0x04, 0x02, 0x0a, 0x00, 0x22, 0x96, 0x02, 0x0a, 0x10, 0x45,
	...
	,
	...
	0x02, 0x0a, 0x00, 0x22, 0x71, 0x0a, 0x08, 0x52, 0x65, 0x64, 0x69, 0x73, 0x55, 0x52, 0x4c, 0x12,
	0x41, 0x0a, 0x0b, 0x72, 0x65, 0x64, 0x69, 0x73, 0x5f, 0x68, 0x6f, 0x73, 0x74, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x2e, 0x48, 0x6f, 0x73, 0x74, 0x42, 0x0e, 0xe2, 0xdf, 0x1f, 0x0a, 0x12, 0x08, 0xea, 0x01,
	0x05, 0x38, 0x80, 0x01, 0x40, 0x01, 0x52, 0x0a, 0x72, 0x65, 0x64, 0x69, 0x73, 0x48, 0x6f, 0x73,
	0x74, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x3a, 0x06,
...
var file_proto_types_model_datasource_datasource_url_proto_goTypes = []interface{}{
	...
	(ElasticSearchURL_Version)(0), // 2: datasource.ElasticSearchURL.Version
...
var file_proto_types_model_datasource_datasource_url_proto_depIdxs = []int32{
	...
	3, // 2: datasource.KafkaURL.kafka_brokers:type_name -> datasource.Host
	2, // 3: datasource.ElasticSearchURL.version:type_name -> datasource.ElasticSearchURL.Version
	3, // 4: datasource.RedisURL.redis_hosts:type_name -> datasource.Host
