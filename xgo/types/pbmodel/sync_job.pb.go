...
type SyncJobArgs struct {
	...
	ElasticSearchSource *ElasticSearchSource `protobuf:"bytes,13,opt,name=elastic_search_source,json=elasticSearchSource,proto3" json:"elastic_search_source"`
	// elasticsearch target
	ElasticSearchTarget *ElasticSearchTarget `protobuf:"bytes,14,opt,name=elastic_search_target,json=elasticSearchTarget,proto3" json:"elastic_search_target"`
	// hdfs source
	...
	// pgwal source
	PgWalSource *PgWalSource `protobuf:"bytes,24,opt,name=pg_wal_source,json=pgWalSource,proto3" json:"pgwal_source"`
	// sqlservercdc source
	SqlserverCdcSource *SqlServerCdcSource `protobuf:"bytes,25,opt,name=sqlserver_cdc_source,json=sqlserverCdcSource,proto3" json:"sqlserver_cdc_source"`
	// logminer source
	LogMinerSource *LogMinerSource `protobuf:"bytes,26,opt,name=log_miner_source,json=logMinerSource,proto3" json:"logminer_source"`
	// redis target
...
type RelationaldbSource struct {
	...
	// split_pk
	SplitPk string `protobuf:"bytes,5,opt,name=split_pk,json=splitPk,proto3" json:"split_pk" swaggerignore:"true"`
}
...
type RelationaldbTarget struct {
	...
	Schema string `protobuf:"bytes,3,opt,name=schema,proto3" json:"schema" swaggerignore:"true"`
	// pre sql
	PreSql []string `protobuf:"bytes,4,rep,name=pre_sql,json=preSql,proto3" json:"pre_sql" swaggerignore:"true"`
	// post sql
	PostSql []string `protobuf:"bytes,5,rep,name=post_sql,json=postSql,proto3" json:"post_sql" swaggerignore:"true"`
	// write mode
	WriteMode string `protobuf:"bytes,6,opt,name=write_mode,json=writeMode,proto3" json:"write_mode" swaggerignore:"true"`
	// batch size
	BatchSize int32 `protobuf:"varint,7,opt,name=batch_size,json=batchSize,proto3" json:"batch_size" swaggerignore:"true"`
	// update key
	UpdateKey []string `protobuf:"bytes,8,rep,name=update_key,json=updateKey,proto3" json:"update_key" swaggerignore:"true"`
	// mode
...
type ElasticSearchSource struct {
	...
	// batch size
	BatchSize int32 `protobuf:"varint,4,opt,name=batch_size,json=batchSize,proto3" json:"batch_size" swaggerignore:"true"`
}
...
type LogMinerSource struct {
	...
	// split update
	SplitUpdate bool `protobuf:"varint,2,opt,name=split_update,json=splitUpdate,proto3" json:"split_update" swaggerignore:"true"`
	// paving data
	PavingData bool `protobuf:"varint,3,opt,name=paving_data,json=pavingData,proto3" json:"paving_data" swaggerignore:"true"`
	// cat
	...
	// start scn
	StartScn string `protobuf:"bytes,7,opt,name=start_scn,json=startScn,proto3" json:"start_scn" swaggerignore:"true"`
	// fetch size
	FetchSize int32 `protobuf:"varint,8,opt,name=fetch_size,json=fetchSize,proto3" json:"fetch_size" swaggerignore:"true"`
	// support auto add log
	SupportAutoAddLog bool `protobuf:"varint,9,opt,name=support_auto_add_log,json=supportAutoAddLog,proto3" json:"support_auto_add_log" swaggerignore:"true"`
	// support auto add log
	QueryTimeout int32 `protobuf:"varint,10,opt,name=query_timeout,json=queryTimeout,proto3" json:"query_timeout" swaggerignore:"true"`
}
...
type PgWalSource struct {
	...
	// status interval
	StatusInterval int32 `protobuf:"varint,4,opt,name=status_interval,json=statusInterval,proto3" json:"status_interval" swaggerignore:"true"`
	// allow created
	AllowCreated bool `protobuf:"varint,5,opt,name=allow_created,json=allowCreated,proto3" json:"allow_created" swaggerignore:"true"`
	// temporary
	Temporary bool `protobuf:"varint,6,opt,name=temporary,proto3" json:"temporary" swaggerignore:"true"`
	// paving data
	PavingData bool `protobuf:"varint,7,opt,name=paving_data,json=pavingData,proto3" json:"paving_data" swaggerignore:"true"`
	// lsn
	Lsn int64 `protobuf:"varint,8,opt,name=lsn,proto3" json:"lsn" swaggerignore:"true"`
	// slot available
	SlotAvailable bool `protobuf:"varint,9,opt,name=slot_available,json=slotAvailable,proto3" json:"slot_available" swaggerignore:"true"`
}
...
type SqlServerCdcSource struct {
	...
	// poll interval
	PollInterval int64 `protobuf:"varint,6,opt,name=poll_interval,json=pollInterval,proto3" json:"poll_interval" swaggerignore:"true"`
	// database name
	DatabaseName string `protobuf:"bytes,7,opt,name=database_name,json=databaseName,proto3" json:"database_name" swaggerignore:"true"`
}
...
type BinlogSource struct {
	...
	// split update
	SplitUpdate bool `protobuf:"varint,5,opt,name=split_update,json=splitUpdate,proto3" json:"split_update" swaggerignore:"true"`
	// paving data
	PavingData bool `protobuf:"varint,6,opt,name=paving_data,json=pavingData,proto3" json:"paving_data" swaggerignore:"true"`
	// filter
	Filter string `protobuf:"bytes,7,opt,name=filter,proto3" json:"filter" swaggerignore:"true"`
	// is gtid mode
	IsGtidMode bool `protobuf:"varint,8,opt,name=is_gtid_mode,json=isGtidMode,proto3" json:"is_gtid_mode" swaggerignore:"true"`
	// query_timeout
	QueryTimeout int32 `protobuf:"varint,9,opt,name=query_timeout,json=queryTimeout,proto3" json:"query_timeout" swaggerignore:"true"`
	// connect_timeout
	ConnectTimeout int32 `protobuf:"varint,10,opt,name=connect_timeout,json=connectTimeout,proto3" json:"connect_timeout" swaggerignore:"true"`
}
...
type Start struct {
	...
	// timestamp
	Timestamp int64 `protobuf:"varint,1,opt,name=timestamp,proto3" json:"timestamp" swaggerignore:"true"`
	// journal name
	JournalName string `protobuf:"bytes,2,opt,name=journal_name,json=journalName,proto3" json:"journal_name" swaggerignore:"true"`
	// position
	Position int64 `protobuf:"varint,3,opt,name=position,proto3" json:"position" swaggerignore:"true"`
}
...
type HiveTarget struct {
	...
	// write mode
	WriteMode string `protobuf:"bytes,7,opt,name=write_mode,json=writeMode,proto3" json:"write_mode" swaggerignore:"true"`
	// Relationaldb column
	FileType string `protobuf:"bytes,8,opt,name=file_type,json=fileType,proto3" json:"file_type" swaggerignore:"true"`
	// default_fs
	DefaultFs string `protobuf:"bytes,9,opt,name=default_fs,json=defaultFs,proto3" json:"default_fs" swaggerignore:"true"`
	// max file size
	...
	// enable dictionary
	EnableDictionary bool `protobuf:"varint,13,opt,name=enable_dictionary,json=enableDictionary,proto3" json:"enable_dictionary" swaggerignore:"true"`
	// encoding
	Encoding string `protobuf:"bytes,14,opt,name=encoding,proto3" json:"encoding" swaggerignore:"true"`
	// field_delimiter
	FieldDelimiter string `protobuf:"bytes,15,opt,name=field_delimiter,json=fieldDelimiter,proto3" json:"field_delimiter" swaggerignore:"true"`
	// compress
	Compress string `protobuf:"bytes,16,opt,name=compress,proto3" json:"compress" swaggerignore:"true"`
	// charset_name
	CharsetName string `protobuf:"bytes,17,opt,name=charset_name,json=charsetName,proto3" json:"charset_name" swaggerignore:"true"`
	// hadoop config
	HadoopConfig string `protobuf:"bytes,18,opt,name=hadoop_config,json=hadoopConfig,proto3" json:"hadoop_config" swaggerignore:"true"`
}
...
type HdfsTarget struct {
	...
	// full column name
	FullColumnName []string `protobuf:"bytes,9,rep,name=full_column_name,json=fullColumnName,proto3" json:"full_column_name" swaggerignore:"true"`
	// full column type
	FullColumnType []string `protobuf:"bytes,10,rep,name=full_column_type,json=fullColumnType,proto3" json:"full_column_type" swaggerignore:"true"`
	// compress
	Compress string `protobuf:"bytes,11,opt,name=compress,proto3" json:"compress" swaggerignore:"true"`
	// max file size
	MaxFileSize int32 `protobuf:"varint,12,opt,name=max_file_size,json=maxFileSize,proto3" json:"max_file_size" swaggerignore:"true"`
	// next check rows
	NextCheckRows int64 `protobuf:"varint,13,opt,name=next_check_rows,json=nextCheckRows,proto3" json:"next_check_rows" swaggerignore:"true"`
	// row group size
	RowGroupSize int32 `protobuf:"varint,14,opt,name=row_group_size,json=rowGroupSize,proto3" json:"row_group_size" swaggerignore:"true"`
	// enable dictionary
	EnableDictionary bool `protobuf:"varint,15,opt,name=enable_dictionary,json=enableDictionary,proto3" json:"enable_dictionary" swaggerignore:"true"`
	// hadoop config
	HadoopConfig string `protobuf:"bytes,16,opt,name=hadoop_config,json=hadoopConfig,proto3" json:"hadoop_config" swaggerignore:"true"`
}
...
type FtpSource struct {
	...
	IsFirstLineHeader bool `protobuf:"varint,8,opt,name=is_first_line_header,json=isFirstLineHeader,proto3" json:"is_first_line_header" swaggerignore:"true"`
	// timeout
...
type FtpTarget struct {
	...
	IsFirstLineHeader bool `protobuf:"varint,8,opt,name=is_first_line_header,json=isFirstLineHeader,proto3" json:"is_first_line_header" swaggerignore:"true"`
	// ftp_file_name
	FtpFileName string `protobuf:"bytes,9,opt,name=ftp_file_name,json=ftpFileName,proto3" json:"ftp_file_name" swaggerignore:"true"`
	// timeout
	Timeout int32 `protobuf:"varint,10,opt,name=timeout,proto3" json:"timeout" swaggerignore:"true"`
}
...
type HbaseReadParameter struct {
	...
	// scan cache size
	ScanCacheSize int32 `protobuf:"varint,6,opt,name=scan_cache_size,json=scanCacheSize,proto3" json:"scan_cache_size" swaggerignore:"true"`
	// hbase scan batch size
	ScanBatchSize int32 `protobuf:"varint,7,opt,name=scan_batch_size,json=scanBatchSize,proto3" json:"scan_batch_size" swaggerignore:"true"`
	// hbase hadoopConfig
	HadoopConfig string `protobuf:"bytes,8,opt,name=hadoopConfig,proto3" json:"hadoopConfig" swaggerignore:"true"`
}
...
type Range struct {
	...
	// start row key
	StartRowKey string `protobuf:"bytes,1,opt,name=start_row_key,json=startRowKey,proto3" json:"start_row_key" swaggerignore:"true"`
	// end row key
	EndRowKey string `protobuf:"bytes,2,opt,name=end_row_key,json=endRowKey,proto3" json:"end_row_key" swaggerignore:"true"`
	// is binary rowkey
	IsBinaryRowkey bool `protobuf:"varint,3,opt,name=is_binary_rowkey,json=isBinaryRowkey,proto3" json:"is_binary_rowkey" swaggerignore:"true"`
}
...
type Table struct {
	...
	// hbase table_name
	TableName string `protobuf:"bytes,1,opt,name=table_name,json=tableName,proto3" json:"table_name" swaggerignore:"true"`
}
...
type HbaseWriteParameter struct {
	...
	Column []*Column `protobuf:"bytes,1,rep,name=column,proto3" json:"column" swaggerignore:"true"`
	// hbase Config
	HbaseConfig string `protobuf:"bytes,2,opt,name=hbase_config,json=hbaseConfig,proto3" json:"hbase_config" swaggerignore:"true"`
	// null_mode
	...
	// write buffer size
	WriteBufferSize int32 `protobuf:"varint,5,opt,name=write_buffer_size,json=writeBufferSize,proto3" json:"write_buffer_size" swaggerignore:"true"`
	// change_log
	...
	VersionColumnIndex int32 `protobuf:"varint,8,opt,name=version_column_index,json=versionColumnIndex,proto3" json:"version_column_index" swaggerignore:"true"`
	...
	// scan cache size
	ScanCacheSize int32 `protobuf:"varint,10,opt,name=scan_cache_size,json=scanCacheSize,proto3" json:"scan_cache_size" swaggerignore:"true"`
	// hbase scan batch size
	ScanBatchSize int32 `protobuf:"varint,11,opt,name=scan_batch_size,json=scanBatchSize,proto3" json:"scan_batch_size" swaggerignore:"true"`
}
...
type KafkaSource struct {
	...
	// timestamp
	Timestamp int64 `protobuf:"varint,4,opt,name=timestamp,proto3" json:"timestamp" swaggerignore:"true"`
	// offset
	...
	ConsumerSettings *ConsumerSettings `protobuf:"bytes,9,opt,name=consumer_settings,json=consumerSettings,proto3" json:"consumer_settings" swaggerignore:"true"`
}
...
type KafkaTarget struct {
	...
	// kafka tableFields
	TableFields []*Column `protobuf:"bytes,1,rep,name=tableFields,proto3" json:"tableFields" swaggerignore:"true"`
	// kafka topic
	Topic string `protobuf:"bytes,2,opt,name=topic,proto3" json:"topic" swaggerignore:"true"`
	// kafka consumer settings
	ConsumerSettings *ConsumerSettings `protobuf:"bytes,3,opt,name=consumer_settings,json=consumerSettings,proto3" json:"consumer_settings" swaggerignore:"true"`
}
...
type RedisTarget struct {
	...
	// select database
	Database int32 `protobuf:"varint,1,opt,name=database,proto3" json:"database" swaggerignore:"true"`
	// keyIndexes
	...
	// expire time
	ExpireTime int64 `protobuf:"varint,4,opt,name=expire_time,json=expireTime,proto3" json:"expire_time" swaggerignore:"true"`
	// type
	Type string `protobuf:"bytes,5,opt,name=type,proto3" json:"type" swaggerignore:"true"`
	// mode
	...
	// timeout
	Timeout int32 `protobuf:"varint,9,opt,name=timeout,proto3" json:"timeout" swaggerignore:"true"`
}
...
var file_proto_types_model_sync_job_proto_rawDesc = []byte{
	...
	0x75, 0x6c, 0x65, 0x22, 0x83, 0x0d, 0x0a, 0x0b, 0x53, 0x79, 0x6e, 0x63, 0x4a, 0x6f, 0x62, 0x41,
	...
	,
	...
	0x1f, 0x0a, 0x12, 0x08, 0xb2, 0x01, 0x05, 0x40, 0x80, 0x86, 0x83, 0x0f, 0x52, 0x08, 0x65, 0x78,
	0x65, 0x63, 0x75, 0x74, 0x65, 0x64, 0x12, 0x25, 0x0a, 0x07, 0x73, 0x74, 0x61, 0x72, 0x74, 0x65,
	...
	0x12, 0x66, 0x0a, 0x12, 0x63, 0x6f, 0x6e, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x5f,
	0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x28, 0x2e, 0x6d,
	...
	,
	...
	0x75, 0x74, 0x6f, 0x10, 0x02, 0x3a, 0x06, 0xca, 0xb2, 0x04, 0x02, 0x0a, 0x00, 0x22, 0xf3, 0x03,
	0x0a, 0x0e, 0x53, 0x79, 0x6e, 0x63, 0x4a, 0x6f, 0x62, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65,
	...
	0x12, 0x23, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x13, 0xe2, 0xdf,
	0x1f, 0x0f, 0x12, 0x0d, 0xc2, 0x01, 0x0a, 0xf0, 0x01, 0x14, 0xca, 0x02, 0x04, 0x73, 0x74, 0x6a,
	0x2d, 0x52, 0x02, 0x69, 0x64, 0x12, 0x26, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0c, 0xe2, 0xdf, 0x1f, 0x08, 0x12, 0x06, 0xc2, 0x01,
	0x03, 0xf0, 0x01, 0x10, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x24, 0x0a,
	...
	0x61, 0x6d, 0x65, 0x12, 0x36, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x13, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x53, 0x79, 0x6e, 0x63, 0x4a, 0x6f,
	0x62, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x42, 0x0d, 0xe2, 0xdf, 0x1f, 0x09, 0x12, 0x07, 0xda, 0x01,
	0x04, 0x30, 0x00, 0x58, 0x01, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x34, 0x0a, 0x06, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x6d, 0x6f,
	0x64, 0x65, 0x6c, 0x2e, 0x53, 0x79, 0x6e, 0x63, 0x4a, 0x6f, 0x62, 0x52, 0x65, 0x6c, 0x65, 0x61,
	...
	0x04, 0x64, 0x65, 0x73, 0x63, 0x12, 0x2b, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6c, 0x75, 0x6d, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18,
	...
	0x6e, 0x64, 0x65, 0x78, 0x12, 0x1d, 0x0a, 0x0a, 0x62, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x73, 0x69,
	0x7a, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x62, 0x61, 0x74, 0x63, 0x68, 0x53,
	0x69, 0x7a, 0x65, 0x22, 0xb0, 0x01, 0x0a, 0x13, 0x45, 0x6c, 0x61, 0x73, 0x74, 0x69, 0x63, 0x53,
	0x65, 0x61, 0x72, 0x63, 0x68, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x12, 0x25, 0x0a, 0x06, 0x63,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x70, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x77, 0x72, 0x69, 0x74, 0x65, 0x5f, 0x6d, 0x6f, 0x64, 0x65,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x77, 0x72, 0x69, 0x74, 0x65, 0x4d, 0x6f, 0x64,
	0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x66, 0x73, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x46, 0x73,
	0x12, 0x1a, 0x0a, 0x08, 0x65, 0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x18, 0x07, 0x20, 0x01,
	...
	,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x12, 0x28, 0x0a, 0x10,
	...
	,
	...
	0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0e, 0x69, 0x73, 0x42, 0x69, 0x6e, 0x61,
	0x72, 0x79, 0x52, 0x6f, 0x77, 0x6b, 0x65, 0x79, 0x22, 0x7f, 0x0a, 0x0b, 0x48, 0x62, 0x61, 0x73,
	0x65, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x12, 0x38, 0x0a, 0x09, 0x70, 0x61, 0x72, 0x61, 0x6d,
	0x65, 0x74, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x2e, 0x48, 0x62, 0x61, 0x73, 0x65, 0x57, 0x72, 0x69, 0x74, 0x65, 0x50, 0x61, 0x72,
	...
	0x6c, 0x65, 0x52, 0x05, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x22, 0x26, 0x0a, 0x05, 0x54, 0x61, 0x62,
	...
	,
	...
	,
...
var file_proto_types_model_sync_job_proto_depIdxs = []int32{
	...
	16, // 8: model.SyncJobArgs.elastic_search_source:type_name -> model.ElasticSearchSource
	17, // 9: model.SyncJobArgs.elastic_search_target:type_name -> model.ElasticSearchTarget
	...
	19, // 19: model.SyncJobArgs.pg_wal_source:type_name -> model.PgWalSource
	20, // 20: model.SyncJobArgs.sqlserver_cdc_source:type_name -> model.SqlServerCdcSource
	18, // 21: model.SyncJobArgs.log_miner_source:type_name -> model.LogMinerSource
	...
	35, // 48: model.KafkaSource.consumer_settings:type_name -> model.ConsumerSettings
	11, // 49: model.KafkaTarget.tableFields:type_name -> model.Column
	35, // 50: model.KafkaTarget.consumer_settings:type_name -> model.ConsumerSettings
