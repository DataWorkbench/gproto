...
var _xxx_xxx_Validator_AdminModule_InEnums_Classify = map[AdminModule_Classify]bool{0: true, 1: true, 2: true, 3: true}
...
func (this *AdminModule) _xxx_xxx_Validator_Validate_classify() error {
	...
	if !(_xxx_xxx_Validator_AdminModule_InEnums_Classify[this.Classify]) {
		return protovalidator.FieldError1("AdminModule", "the value of field 'classify' must in enums of '[0 1 2 3]'", protovalidator.Int32ToString(int32(this.Classify)))
	}
	return nil
}
