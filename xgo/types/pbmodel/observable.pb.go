...
type WorkspaceOverview_FlinkCluster struct {
	...
	CuTotal int64 `protobuf:"varint,7,opt,name=cu_total,json=cuTotal,proto3" json:"cu_total" gorm:"cu_total;<-:false"`
	// The number CU of flink cluster in the workspace that are in the running status.
	CuRunning int64 `protobuf:"varint,8,opt,name=cu_running,json=cuRunning,proto3" json:"cu_running" gorm:"cu_running;<-:false"`
	// The number CU of flink cluster in the workspace that are in the stopped status.
	CuStopped int64 `protobuf:"varint,9,opt,name=cu_stopped,json=cuStopped,proto3" json:"cu_stopped" gorm:"cu_stopped;<-:false"`
	// The number CU of flink cluster in the workspace that are in the starting status.
	CuStarting int64 `protobuf:"varint,10,opt,name=cu_starting,json=cuStarting,proto3" json:"cu_starting" gorm:"cu_starting;<-:false"`
	// The number CU of flink cluster in the workspace that are in the exception status.
	CuException int64 `protobuf:"varint,11,opt,name=cu_exception,json=cuException,proto3" json:"cu_exception" gorm:"cu_exception;<-:false"`
	// The number CU of flink cluster in the workspace that are in the arrears status.
	CuArrears int64 `protobuf:"varint,12,opt,name=cu_arrears,json=cuArrears,proto3" json:"cu_arrears" gorm:"cu_arrears;<-:false"`
}
...
func (x *WorkspaceOverview_FlinkCluster) GetCuTotal() int64 {
	if x != nil {
		return x.CuTotal
	}
	return 0
...
func (x *WorkspaceOverview_FlinkCluster) GetCuRunning() int64 {
	if x != nil {
		return x.CuRunning
	}
	return 0
...
func (x *WorkspaceOverview_FlinkCluster) GetCuStopped() int64 {
	if x != nil {
		return x.CuStopped
	}
	return 0
...
func (x *WorkspaceOverview_FlinkCluster) GetCuStarting() int64 {
	if x != nil {
		return x.CuStarting
	}
	return 0
...
func (x *WorkspaceOverview_FlinkCluster) GetCuException() int64 {
	if x != nil {
...
func (x *WorkspaceOverview_FlinkCluster) GetCuArrears() int64 {
	if x != nil {
		return x.CuArrears
	}
	return 0
...
var file_proto_types_model_observable_proto_rawDesc = []byte{
	...
	,
