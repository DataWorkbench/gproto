...
type PgWalSource struct {
	...
	// allow created
	AllowCreated bool `protobuf:"varint,3,opt,name=allow_created,json=allowCreated,proto3" json:"allow_created"`
	// status interval
	...
	// cat
	Cat string `protobuf:"bytes,11,opt,name=cat,proto3" json:"cat"`
}
...
func (x *PgWalSource) GetCat() string {
	if x != nil {
		return x.Cat
	}
	return ""
...
var file_proto_types_model_syncjob_pgwal_proto_rawDesc = []byte{
	...
	0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe6, 0x02, 0x0a, 0x0b, 0x50, 0x67, 0x57, 0x61,
	...
	0x61, 0x74, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x61, 0x6c, 0x6c, 0x6f,
	...
	0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x12, 0x10, 0x0a, 0x03, 0x63, 0x61, 0x74, 0x18, 0x0b, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x03, 0x63, 0x61, 0x74, 0x3a, 0x06, 0xca, 0xb2, 0x04, 0x02, 0x0a, 0x00,
	0x42, 0x76, 0x0a, 0x2c, 0x63, 0x6f, 0x6d, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6f, 0x6d, 0x6e, 0x69,
	...
	0x42, 0x07, 0x50, 0x42, 0x50, 0x67, 0x77, 0x61, 0x6c, 0x50, 0x00, 0x5a, 0x3b, 0x67, 0x69, 0x74,
