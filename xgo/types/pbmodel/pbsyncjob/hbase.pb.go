...
type HbaseSource struct {
	...
	// encoding
	Encoding BaseEnum_Encoding `protobuf:"varint,3,opt,name=encoding,proto3,enum=model.BaseEnum_Encoding" json:"encoding"`
	// scan cache size
	ScanCacheSize int32 `protobuf:"varint,4,opt,name=scan_cache_size,json=scanCacheSize,proto3" json:"scan_cache_size"`
	// hbase scan batch size
	ScanBatchSize int32  `protobuf:"varint,5,opt,name=scan_batch_size,json=scanBatchSize,proto3" json:"scan_batch_size"`
	StartRowKey   string `protobuf:"bytes,6,opt,name=start_row_key,json=startRowKey,proto3" json:"start_row_key"`
	// end row key
	EndRowKey string `protobuf:"bytes,7,opt,name=end_row_key,json=endRowKey,proto3" json:"end_row_key"`
	// is binary rowkey
	IsBinaryRowkey bool `protobuf:"varint,8,opt,name=is_binary_rowkey,json=isBinaryRowkey,proto3" json:"is_binary_rowkey"`
}
...
func (x *HbaseSource) GetEncoding() BaseEnum_Encoding {
	if x != nil {
		return x.Encoding
	}
...
type HbaseTarget struct {
	...
	// rowkey express
	RowkeyExpress string `protobuf:"bytes,6,opt,name=rowkey_express,json=rowkeyExpress,proto3" json:"rowkey_express"`
	// version column index
	VersionColumnIndex int32 `protobuf:"varint,7,opt,name=version_column_index,json=versionColumnIndex,proto3" json:"version_column_index"`
	// version column value
	VersionColumnValue string `protobuf:"bytes,8,opt,name=version_column_value,json=versionColumnValue,proto3" json:"version_column_value"`
	// hbase scan batch size
	Encoding BaseEnum_Encoding `protobuf:"varint,9,opt,name=encoding,proto3,enum=model.BaseEnum_Encoding" json:"encoding"`
}
...
func (x *HbaseTarget) GetEncoding() BaseEnum_Encoding {
	if x != nil {
		return x.Encoding
	}
	return BaseEnum_EncodingUnset
...
var file_proto_types_model_syncjob_hbase_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xc6, 0x02, 0x0a, 0x0b, 0x48, 0x62, 0x61, 0x73, 0x65, 0x53, 0x6f, 0x75, 0x72, 0x63,
	...
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x34,
	0x0a, 0x08, 0x65, 0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x18, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x42, 0x61, 0x73, 0x65, 0x45, 0x6e, 0x75,
	0x6d, 0x2e, 0x45, 0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x52, 0x08, 0x65, 0x6e, 0x63, 0x6f,
	0x64, 0x69, 0x6e, 0x67, 0x12, 0x26, 0x0a, 0x0f, 0x73, 0x63, 0x61, 0x6e, 0x5f, 0x63, 0x61, 0x63,
	0x68, 0x65, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x73,
	...
	,
	...
	0x52, 0x05, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x35, 0x0a, 0x09, 0x6e, 0x75, 0x6c, 0x6c, 0x5f,
	0x6d, 0x6f, 0x64, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x2e, 0x42, 0x61, 0x73, 0x65, 0x45, 0x6e, 0x75, 0x6d, 0x2e, 0x4e, 0x75, 0x6c, 0x6c,
	0x4d, 0x6f, 0x64, 0x65, 0x52, 0x08, 0x6e, 0x75, 0x6c, 0x6c, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x19,
	...
	,
...
var file_proto_types_model_syncjob_hbase_proto_goTypes = []interface{}{
	...
	(BaseEnum_Encoding)(0), // 3: model.BaseEnum.Encoding
	(BaseEnum_NullMode)(0), // 4: model.BaseEnum.NullMode
}
var file_proto_types_model_syncjob_hbase_proto_depIdxs = []int32{
	2, // 0: model.HbaseSource.column:type_name -> model.Column
	3, // 1: model.HbaseSource.encoding:type_name -> model.BaseEnum.Encoding
	2, // 2: model.HbaseTarget.column:type_name -> model.Column
	4, // 3: model.HbaseTarget.null_mode:type_name -> model.BaseEnum.NullMode
	3, // 4: model.HbaseTarget.encoding:type_name -> model.BaseEnum.Encoding
