...
type RelationaldbTarget_Mode int32

const (
	RelationaldbTarget_insert  RelationaldbTarget_Mode = 0
	RelationaldbTarget_replace RelationaldbTarget_Mode = 1
	RelationaldbTarget_update  RelationaldbTarget_Mode = 2
)

// Enum value maps for RelationaldbTarget_Mode.
var (
	RelationaldbTarget_Mode_name = map[int32]string{
		0: "insert",
		1: "replace",
		2: "update",
	}
	RelationaldbTarget_Mode_value = map[string]int32{
		"insert":  0,
		"replace": 1,
		"update":  2,
	}
...
func (x RelationaldbTarget_Mode) Enum() *RelationaldbTarget_Mode {
	p := new(RelationaldbTarget_Mode)
	*p = x
	return p
}

func (x RelationaldbTarget_Mode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RelationaldbTarget_Mode) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_types_model_syncjob_relationaldb_proto_enumTypes[0].Descriptor()
}

func (RelationaldbTarget_Mode) Type() protoreflect.EnumType {
	return &file_proto_types_model_syncjob_relationaldb_proto_enumTypes[0]
}

func (x RelationaldbTarget_Mode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RelationaldbTarget_Mode.Descriptor instead.
func (RelationaldbTarget_Mode) EnumDescriptor() ([]byte, []int) {
...
const (
	RelationaldbTarget_at_least_once RelationaldbTarget_Semantic = 0
	RelationaldbTarget_exactly_once  RelationaldbTarget_Semantic = 1
)
...
type RelationaldbTarget struct {
	...
	// mode
	Mode RelationaldbTarget_Mode `protobuf:"varint,9,opt,name=mode,proto3,enum=model.RelationaldbTarget_Mode" json:"mode"`
	// semantic
	Semantic RelationaldbTarget_Semantic `protobuf:"varint,10,opt,name=semantic,proto3,enum=model.RelationaldbTarget_Semantic" json:"semantic"`
	// with no lock
...
func (x *RelationaldbTarget) GetMode() RelationaldbTarget_Mode {
	if x != nil {
		return x.Mode
	}
...
func (x *RelationaldbTarget) GetSemantic() RelationaldbTarget_Semantic {
	...
	return RelationaldbTarget_at_least_once
}
...
var file_proto_types_model_syncjob_relationaldb_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x50, 0x6b, 0x22, 0xee, 0x03, 0x0a, 0x12, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f,
	...
	,
	...
	0x74, 0x65, 0x10, 0x02, 0x22, 0x2f, 0x0a, 0x08, 0x53, 0x65, 0x6d, 0x61, 0x6e, 0x74, 0x69, 0x63,
	0x12, 0x11, 0x0a, 0x0d, 0x61, 0x74, 0x5f, 0x6c, 0x65, 0x61, 0x73, 0x74, 0x5f, 0x6f, 0x6e, 0x63,
	0x65, 0x10, 0x00, 0x12, 0x10, 0x0a, 0x0c, 0x65, 0x78, 0x61, 0x63, 0x74, 0x6c, 0x79, 0x5f, 0x6f,
	0x6e, 0x63, 0x65, 0x10, 0x01, 0x42, 0x7d, 0x0a, 0x2c, 0x63, 0x6f, 0x6d, 0x2e, 0x64, 0x61, 0x74,
	...
	0x6e, 0x63, 0x6a, 0x6f, 0x62, 0x42, 0x0e, 0x50, 0x42, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x61, 0x6c, 0x64, 0x62, 0x50, 0x00, 0x5a, 0x3b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_proto_types_model_syncjob_relationaldb_proto_goTypes = []interface{}{
	(RelationaldbTarget_Mode)(0),     // 0: model.RelationaldbTarget.Mode
...
var file_proto_types_model_syncjob_relationaldb_proto_depIdxs = []int32{
	...
	0, // 2: model.RelationaldbTarget.mode:type_name -> model.RelationaldbTarget.Mode
