...
type RelationaldbSource struct {
	...
	// mapping type
	MappingType Column_ColumnMapping `protobuf:"varint,6,opt,name=mapping_type,json=mappingType,proto3,enum=model.Column_ColumnMapping" json:"mapping_type"`
}
...
func (x *RelationaldbSource) GetMappingType() Column_ColumnMapping {
	if x != nil {
...
var file_proto_types_model_syncjob_relationaldb_proto_rawDesc = []byte{
	...
	0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xda, 0x01, 0x0a, 0x12, 0x52, 0x65, 0x6c, 0x61,
	...
	0x69, 0x74, 0x50, 0x6b, 0x12, 0x3e, 0x0a, 0x0c, 0x6d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x5f,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x2e, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x2e, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e,
	0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x52, 0x0b, 0x6d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67,
	0x54, 0x79, 0x70, 0x65, 0x22, 0xe1, 0x03, 0x0a, 0x12, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f,
...
var file_proto_types_model_syncjob_relationaldb_proto_goTypes = []interface{}{
	...
	(Column_ColumnMapping)(0),         // 5: model.Column.ColumnMapping
}
var file_proto_types_model_syncjob_relationaldb_proto_depIdxs = []int32{
	...
	5, // 1: model.RelationaldbSource.mapping_type:type_name -> model.Column.ColumnMapping
	4, // 2: model.RelationaldbTarget.column:type_name -> model.Column
	0, // 3: model.RelationaldbTarget.write_mode:type_name -> model.RelationaldbTarget.WriteMode
	1, // 4: model.RelationaldbTarget.semantic:type_name -> model.RelationaldbTarget.Semantic
