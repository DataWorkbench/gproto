...
var _xxx_xxx_Validator_SyncJob_InEnums_Type = map[SyncJob_Type]bool{0: true, 1: true, 2: true}
...
func (this *SyncJob) _xxx_xxx_Validator_Validate_type() error {
	...
	if !(_xxx_xxx_Validator_SyncJob_InEnums_Type[this.Type]) {
		return protovalidator.FieldError1("SyncJob", "the value of field 'type' must in enums of '[0 1 2]'", protovalidator.Int32ToString(int32(this.Type)))
	}
	return nil
}
...
func (this *SyncJob) _xxx_xxx_Validator_Validate_source_type() error {
	if !(this.SourceType >= 0) {
		return protovalidator.FieldError1("SyncJob", "the value of field 'source_type' must be greater than or equal to '0'", protovalidator.Int32ToString(int32(this.SourceType)))
	}
...
func (this *SyncJob) _xxx_xxx_Validator_Validate_target_type() error {
	if !(this.TargetType >= 0) {
		return protovalidator.FieldError1("SyncJob", "the value of field 'target_type' must be greater than or equal to '0'", protovalidator.Int32ToString(int32(this.TargetType)))
	}
...
var _xxx_xxx_Validator_SyncJobRelease_InEnums_Type = map[SyncJob_Type]bool{0: true, 1: true, 2: true}
...
func (this *SyncJobRelease) _xxx_xxx_Validator_Validate_type() error {
	...
	if !(_xxx_xxx_Validator_SyncJobRelease_InEnums_Type[this.Type]) {
		return protovalidator.FieldError1("SyncJobRelease", "the value of field 'type' must in enums of '[0 1 2]'", protovalidator.Int32ToString(int32(this.Type)))
	}
	return nil
}
