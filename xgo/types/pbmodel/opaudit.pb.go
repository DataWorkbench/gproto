...
const (
	OpAudit_StateUnset OpAudit_State = 0
...
type OpAudit struct {
	...
	ApiName string `protobuf:"bytes,3,opt,name=api_name,json=apiName,proto3" json:"api_name" gorm:"column:api_name;"`
	// -- The type of operation, 2 => "Write",  3 => "Read".
	PermType ProjectAPI_PermType `protobuf:"varint,4,opt,name=perm_type,json=permType,proto3,enum=model.ProjectAPI_PermType" json:"perm_type" gorm:"column:perm_type;"`
...
func (x *OpAudit) GetApiName() string {
	if x != nil {
		return x.ApiName
	}
	return ""
...
func (x *OpAudit) GetPermType() ProjectAPI_PermType {
	if x != nil {
		return x.PermType
	}
...
var file_proto_types_model_opaudit_proto_rawDesc = []byte{
	...
	,
	...
	0x01, 0x52, 0x08, 0x70, 0x65, 0x72, 0x6d, 0x54, 0x79, 0x70, 0x65, 0x12, 0x39, 0x0a, 0x05, 0x73,
	0x74, 0x61, 0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x2e, 0x4f, 0x70, 0x41, 0x75, 0x64, 0x69, 0x74, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	0x01, 0x02, 0x30, 0x00, 0x52, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x22, 0x30, 0x0a,
	...
	0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x42, 0x0e, 0x50, 0x42, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x4f, 0x70,
	0x41, 0x75, 0x64, 0x69, 0x74, 0x50, 0x00, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_proto_types_model_opaudit_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_proto_types_model_opaudit_proto_goTypes = []interface{}{
	(OpAudit_State)(0),       // 0: model.OpAudit.State
	(*OpAudit)(nil),          // 1: model.OpAudit
	(ProjectAPI_PermType)(0), // 2: model.ProjectAPI.PermType
}
var file_proto_types_model_opaudit_proto_depIdxs = []int32{
	2, // 0: model.OpAudit.perm_type:type_name -> model.ProjectAPI.PermType
	0, // 1: model.OpAudit.state:type_name -> model.OpAudit.State
