...
type NotificationList struct {
	...
	Items                []*NotificationListItem `protobuf:"bytes,2,rep,name=items,proto3" json:"items,omitempty"`
	NotificationListId   string                  `protobuf:"bytes,3,opt,name=notification_list_id,json=notificationListId,proto3" json:"notification_list_id,omitempty"`
	NotificationListName string                  `protobuf:"bytes,4,opt,name=notification_list_name,json=notificationListName,proto3" json:"notification_list_name,omitempty"`
...
func (x *NotificationList) GetItems() []*NotificationListItem {
	if x != nil {
		return x.Items
	}
	return nil
...
type NotificationListItem struct {
	...
	NotificationItemId   string `protobuf:"bytes,3,opt,name=notification_item_id,json=notificationItemId,proto3" json:"notification_item_id,omitempty"`
	NotificationItemType string `protobuf:"bytes,4,opt,name=notification_item_type,json=notificationItemType,proto3" json:"notification_item_type,omitempty"`
}

func (x *NotificationListItem) Reset() {
...
func (x *NotificationListItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NotificationListItem) ProtoMessage() {}

func (x *NotificationListItem) ProtoReflect() protoreflect.Message {
	mi := &file_proto_types_model_notifier_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NotificationListItem.ProtoReflect.Descriptor instead.
func (*NotificationListItem) Descriptor() ([]byte, []int) {
	return file_proto_types_model_notifier_proto_rawDescGZIP(), []int{1}
}

func (x *NotificationListItem) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
func (x *NotificationListItem) GetCreateTime() string {
	if x != nil {
		return x.CreateTime
	}
	return ""
...
func (x *NotificationListItem) GetNotificationItemId() string {
	if x != nil {
...
func (x *NotificationListItem) GetNotificationItemType() string {
	if x != nil {
...
var file_proto_types_model_notifier_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x50, 0x00, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68,
...
var file_proto_types_model_notifier_proto_goTypes = []interface{}{
	...
	(*NotificationListItem)(nil), // 1: model.NotificationListItem
}
var file_proto_types_model_notifier_proto_depIdxs = []int32{
	1, // 0: model.NotificationList.items:type_name -> model.NotificationListItem
...
func file_proto_types_model_notifier_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_types_model_notifier_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NotificationListItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
