...
type CreateFlinkCluster struct {
	...
	TaskNum int32 `protobuf:"varint,5,opt,name=task_num,json=taskNum,proto3" json:"task_num"`
	// Flink JobManager. 1CU = 1C + 4GB. Is required, Min 0.5, Max 8
	JobCu float32 `protobuf:"fixed32,6,opt,name=job_cu,json=jobCu,proto3" json:"job_cu"`
	// Flink TaskManager. 1CU = 1C + 4GB. Is required, Min 0.5, Max 8
	TaskCu float32 `protobuf:"fixed32,7,opt,name=task_cu,json=taskCu,proto3" json:"task_cu"`
	// Network config. Is required.
	NetworkId string `protobuf:"bytes,8,opt,name=network_id,json=networkId,proto3" json:"network_id"`
	// Config of host aliases. Not required.
	HostAliases *pbmodel.HostAliases `protobuf:"bytes,9,opt,name=host_aliases,json=hostAliases,proto3" json:"host_aliases"`
	...
	SpaceOwner string `protobuf:"bytes,11,opt,name=space_owner,json=spaceOwner,proto3" json:"space_owner" swaggerignore:"true"`
}
...
var file_proto_types_request_cluster_manage_proto_rawDesc = []byte{
	...
	0x2f, 0x66, 0x6c, 0x69, 0x6e, 0x6b, 0x2f, 0x66, 0x6c, 0x69, 0x6e, 0x6b, 0x5f, 0x63, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x76, 0x0a, 0x17, 0x44, 0x65, 0x73,
	0x63, 0x72, 0x69, 0x62, 0x65, 0x46, 0x6c, 0x69, 0x6e, 0x6b, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65,
	0x72, 0x41, 0x50, 0x49, 0x12, 0x2e, 0x0a, 0x08, 0x73, 0x70, 0x61, 0x63, 0x65, 0x5f, 0x69, 0x64,
	...
	0x64, 0x22, 0x8c, 0x03, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x6c, 0x69, 0x6e, 0x6b, 0x43,
	...
	0xdf, 0x1f, 0x00, 0x52, 0x06, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x12, 0x3f, 0x0a, 0x06, 0x73,
	...
	0x01, 0x02, 0x58, 0x01, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x18, 0x0a, 0x04,
	...
	0x22, 0x81, 0x01, 0x0a, 0x13, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x46, 0x6c, 0x69, 0x6e, 0x6b,
	0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73, 0x12, 0x2e, 0x0a, 0x08, 0x73, 0x70, 0x61, 0x63,
	...
	0x07, 0x73, 0x70, 0x61, 0x63, 0x65, 0x49, 0x64, 0x12, 0x3a, 0x0a, 0x0b, 0x63, 0x6c, 0x75, 0x73,
	0x74, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x42, 0x19, 0xe2,
	0xdf, 0x1f, 0x15, 0x12, 0x13, 0xea, 0x01, 0x10, 0x30, 0x00, 0x38, 0x64, 0x5a, 0x0a, 0xc2, 0x01,
	0x07, 0xca, 0x02, 0x04, 0x63, 0x66, 0x69, 0x2d, 0x52, 0x0a, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65,
	0x72, 0x49, 0x64, 0x73, 0x22, 0x80, 0x01, 0x0a, 0x12, 0x53, 0x74, 0x61, 0x72, 0x74, 0x46, 0x6c,
	...
	0x0a, 0xc2, 0x01, 0x07, 0xca, 0x02, 0x04, 0x63, 0x66, 0x69, 0x2d, 0x52, 0x0a, 0x63, 0x6c, 0x75,
	0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x73, 0x22, 0x7f, 0x0a, 0x11, 0x53, 0x74, 0x6f, 0x70, 0x46,
	...
	0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x73, 0x22, 0xae, 0x04, 0x0a, 0x12, 0x43, 0x72, 0x65,
	...
	0x6d, 0x65, 0x12, 0x3c, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x09, 0x42, 0x22, 0xe2, 0xdf, 0x1f, 0x1e, 0x12, 0x1c, 0xc2, 0x01, 0x19, 0x4a, 0x17,
	0x66, 0x6c, 0x69, 0x6e, 0x6b, 0x2d, 0x31, 0x2e, 0x31, 0x32, 0x2e, 0x33, 0x2d, 0x73, 0x63, 0x61,
	0x6c, 0x61, 0x5f, 0x32, 0x2e, 0x31, 0x31, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
	0x12, 0x28, 0x0a, 0x08, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x6e, 0x75, 0x6d, 0x18, 0x05, 0x20, 0x01,
	...
	0x62, 0x5f, 0x63, 0x75, 0x18, 0x06, 0x20, 0x01, 0x28, 0x02, 0x42, 0x1b, 0xe2, 0xdf, 0x1f, 0x17,
	...
	0x0a, 0x07, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x63, 0x75, 0x18, 0x07, 0x20, 0x01, 0x28, 0x02, 0x42,
	...
	,
	...
	0x65, 0x72, 0x49, 0x64, 0x12, 0x24, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x42, 0x10, 0xe2, 0xdf, 0x1f, 0x0c, 0x12, 0x0a, 0xc2, 0x01, 0x07, 0x80, 0x02, 0x01,
	0x98, 0x02, 0x80, 0x01, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x28, 0x0a, 0x08, 0x74, 0x61,
	0x73, 0x6b, 0x5f, 0x6e, 0x75, 0x6d, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x42, 0x0d, 0xe2, 0xdf,
	0x1f, 0x09, 0x12, 0x07, 0xb2, 0x01, 0x04, 0x38, 0x18, 0x40, 0x01, 0x52, 0x07, 0x74, 0x61, 0x73,
	0x6b, 0x4e, 0x75, 0x6d, 0x12, 0x32, 0x0a, 0x06, 0x6a, 0x6f, 0x62, 0x5f, 0x63, 0x75, 0x18, 0x06,
	...
	0x00, 0x00, 0x00, 0x00, 0xe0, 0x3f, 0x52, 0x06, 0x74, 0x61, 0x73, 0x6b, 0x43, 0x75, 0x12, 0x32,
	0x0a, 0x0a, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x09, 0x42, 0x13, 0xe2, 0xdf, 0x1f, 0x0f, 0x12, 0x0d, 0xc2, 0x01, 0x0a, 0xf0, 0x01, 0x14,
	...
	0x65, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x2c, 0x0a, 0x0b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x5f, 0x6f,
	0x77, 0x6e, 0x65, 0x72, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0b, 0xe2, 0xdf, 0x1f, 0x07,
	0x12, 0x05, 0xc2, 0x01, 0x02, 0x22, 0x00, 0x52, 0x0a, 0x73, 0x70, 0x61, 0x63, 0x65, 0x4f, 0x77,
	0x6e, 0x65, 0x72, 0x22, 0x4a, 0x0a, 0x14, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x46,
	...
	0x63, 0x66, 0x69, 0x2d, 0x52, 0x09, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x42,
	...
	0x73, 0x74, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x50,
