...
var _xxx_xxx_Validator_SubmitFlinkJob_InEnums_Type = map[pbmodel.StreamJob_Type]bool{0: true, 1: true, 2: true, 3: true, 4: true}
...
func (this *SubmitFlinkJob) _xxx_xxx_Validator_Validate_type() error {
	...
	if !(_xxx_xxx_Validator_SubmitFlinkJob_InEnums_Type[this.Type]) {
		return protovalidator.FieldError1("SubmitFlinkJob", "the value of field 'type' must in enums of '[0 1 2 3 4]'", protovalidator.Int32ToString(int32(this.Type)))
	}
	return nil
}
