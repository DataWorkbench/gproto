...
var file_proto_types_request_datasource_manage_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x42, 0x78, 0x0a, 0x24, 0x63,
	...
	0x65, 0x73, 0x74, 0x42, 0x19, 0x50, 0x42, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x44, 0x61,
	0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x50, 0x00,
...
var file_proto_types_request_datasource_manage_proto_goTypes = []interface{}{
	...
	(pbmodel.DataSource_Status)(0),        // 13: model.DataSource.Status
	(*pbmodel.DataSource_URL)(nil),        // 14: model.DataSource.URL
	(*pbmodel.DataSourceConnection)(nil),  // 15: model.DataSourceConnection
}
var file_proto_types_request_datasource_manage_proto_depIdxs = []int32{
	12, // 0: request.ListDataSources.type:type_name -> model.DataSource.Type
	13, // 1: request.ListDataSources.status:type_name -> model.DataSource.Status
	12, // 2: request.CreateDataSource.type:type_name -> model.DataSource.Type
	14, // 3: request.CreateDataSource.url:type_name -> model.DataSource.URL
	15, // 4: request.CreateDataSource.last_connection:type_name -> model.DataSourceConnection
	12, // 5: request.UpdateDataSource.type:type_name -> model.DataSource.Type
	14, // 6: request.UpdateDataSource.url:type_name -> model.DataSource.URL
	15, // 7: request.UpdateDataSource.last_connection:type_name -> model.DataSourceConnection
	0,  // 8: request.PingDataSourceConnection.stage:type_name -> request.PingDataSourceConnection.Stage
	12, // 9: request.PingDataSourceConnection.type:type_name -> model.DataSource.Type
	14, // 10: request.PingDataSourceConnection.url:type_name -> model.DataSource.URL
