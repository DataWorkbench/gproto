...
type CreateSyncInstanceWithId struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CreateSyncInstanceWithId) Reset() {
	*x = CreateSyncInstanceWithId{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_types_request_sync_instance_manage_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *CreateSyncInstanceWithId) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateSyncInstanceWithId) ProtoMessage() {}

func (x *CreateSyncInstanceWithId) ProtoReflect() protoreflect.Message {
	mi := &file_proto_types_request_sync_instance_manage_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateSyncInstanceWithId.ProtoReflect.Descriptor instead.
func (*CreateSyncInstanceWithId) Descriptor() ([]byte, []int) {
	return file_proto_types_request_sync_instance_manage_proto_rawDescGZIP(), []int{5}
}

func (x *CreateSyncInstanceWithId) GetSpaceId() string {
	if x != nil {
		return x.SpaceId
	}
	return ""
...
func (x *CreateSyncInstanceWithId) GetJobId() string {
	if x != nil {
		return x.JobId
	}
	return ""
...
func (x *CreateSyncInstanceWithId) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *CreateSyncInstanceWithId) GetInstanceId() string {
	if x != nil {
		return x.InstanceId
	}
	return ""
...
func (x *CreateSyncInstanceWithId) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type UpdateSyncInstanceState struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	InstanceId string                     `protobuf:"bytes,1,opt,name=instance_id,json=instanceId,proto3" json:"instance_id,omitempty"`
	State      pbmodel.SyncInstance_State `protobuf:"varint,2,opt,name=state,proto3,enum=model.SyncInstance_State" json:"state,omitempty"`
	Message    string                     `protobuf:"bytes,3,opt,name=message,proto3" json:"message,omitempty"`
}

func (x *UpdateSyncInstanceState) Reset() {
	*x = UpdateSyncInstanceState{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_types_request_sync_instance_manage_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *UpdateSyncInstanceState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateSyncInstanceState) ProtoMessage() {}

func (x *UpdateSyncInstanceState) ProtoReflect() protoreflect.Message {
	mi := &file_proto_types_request_sync_instance_manage_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateSyncInstanceState.ProtoReflect.Descriptor instead.
func (*UpdateSyncInstanceState) Descriptor() ([]byte, []int) {
	return file_proto_types_request_sync_instance_manage_proto_rawDescGZIP(), []int{6}
}

func (x *UpdateSyncInstanceState) GetInstanceId() string {
	if x != nil {
		return x.InstanceId
	}
	return ""
...
func (x *UpdateSyncInstanceState) GetState() pbmodel.SyncInstance_State {
	if x != nil {
		return x.State
	}
	return pbmodel.SyncInstance_State(0)
...
func (x *UpdateSyncInstanceState) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_proto_types_request_sync_instance_manage_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x76, 0x65, 0x72, 0x62, 0x6f, 0x73, 0x65, 0x22, 0xee, 0x01, 0x0a, 0x18, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x53, 0x79, 0x6e, 0x63, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65,
	0x57, 0x69, 0x74, 0x68, 0x49, 0x64, 0x12, 0x2e, 0x0a, 0x08, 0x73, 0x70, 0x61, 0x63, 0x65, 0x5f,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x13, 0xe2, 0xdf, 0x1f, 0x0f, 0x12, 0x0d,
	0xc2, 0x01, 0x0a, 0xf0, 0x01, 0x14, 0xca, 0x02, 0x04, 0x77, 0x6b, 0x73, 0x2d, 0x52, 0x07, 0x73,
	...
	0x10, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x34, 0x0a, 0x0b, 0x69, 0x6e,
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42,
	0x13, 0xe2, 0xdf, 0x1f, 0x0f, 0x12, 0x0d, 0xc2, 0x01, 0x0a, 0xf0, 0x01, 0x14, 0xca, 0x02, 0x04,
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xa9, 0x01, 0x0a, 0x17, 0x55,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x79, 0x6e, 0x63, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63,
	...
	,
...
var file_proto_types_request_sync_instance_manage_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_proto_types_request_sync_instance_manage_proto_goTypes = []interface{}{
	...
	(*CreateSyncInstanceWithId)(nil), // 5: request.CreateSyncInstanceWithId
	(*UpdateSyncInstanceState)(nil),  // 6: request.UpdateSyncInstanceState
	(pbmodel.SyncInstance_State)(0),  // 7: model.SyncInstance.State
}
var file_proto_types_request_sync_instance_manage_proto_depIdxs = []int32{
	7, // 0: request.ListSyncInstances.state:type_name -> model.SyncInstance.State
	7, // 1: request.UpdateSyncInstanceState.state:type_name -> model.SyncInstance.State
...
func file_proto_types_request_sync_instance_manage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_types_request_sync_instance_manage_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateSyncInstanceWithId); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_types_request_sync_instance_manage_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateSyncInstanceState); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
