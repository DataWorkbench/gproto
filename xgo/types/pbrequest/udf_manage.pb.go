...
type ListUDFs struct {
	...
	UdfType pbmodel.UDF_Type `protobuf:"varint,7,opt,name=udf_type,json=udfType,proto3,enum=model.UDF_Type" json:"udf_type" form:"udf_type"`
}
...
func (x *ListUDFs) GetUdfType() pbmodel.UDF_Type {
	if x != nil {
		return x.UdfType
	}
...
type CreateUDF struct {
	...
	UdfType pbmodel.UDF_Type `protobuf:"varint,6,opt,name=udf_type,json=udfType,proto3,enum=model.UDF_Type" json:"udf_type"`
	// UDF language one of 1/2/3 1=>Scala/2=>Java/3=>Python
	UdfLanguage pbmodel.UDF_Language `protobuf:"varint,7,opt,name=udf_language,json=udfLanguage,proto3,enum=model.UDF_Language" json:"udf_language"`
	// Udf owner.
...
func (x *CreateUDF) GetUdfType() pbmodel.UDF_Type {
	if x != nil {
		return x.UdfType
	}
	return pbmodel.UDF_Type(0)
...
func (x *CreateUDF) GetUdfLanguage() pbmodel.UDF_Language {
	if x != nil {
...
var file_proto_types_request_udf_manage_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcb, 0x02, 0x0a, 0x08, 0x4c, 0x69, 0x73, 0x74, 0x55, 0x44,
	...
	,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0d, 0xe2,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x11, 0xe2, 0xdf, 0x1f, 0x0d, 0x12, 0x0b, 0xc2, 0x01, 0x08,
	...
	0x6c, 0x65, 0x12, 0x39, 0x0a, 0x08, 0x75, 0x64, 0x66, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x06,
	...
	0x30, 0x00, 0x58, 0x01, 0x52, 0x07, 0x75, 0x64, 0x66, 0x54, 0x79, 0x70, 0x65, 0x12, 0x45, 0x0a,
	0x0c, 0x75, 0x64, 0x66, 0x5f, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x55, 0x44, 0x46, 0x2e,
	...
	,
	...
	0x65, 0x73, 0x74, 0x42, 0x12, 0x50, 0x42, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x55, 0x44,
	0x46, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x50, 0x00, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_proto_types_request_udf_manage_proto_depIdxs = []int32{
	5, // 0: request.ListUDFs.udf_type:type_name -> model.UDF.Type
	5, // 1: request.CreateUDF.udf_type:type_name -> model.UDF.Type
	6, // 2: request.CreateUDF.udf_language:type_name -> model.UDF.Language
