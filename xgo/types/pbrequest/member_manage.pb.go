...
func (x *UpsertMember) GetSpaceId() string {
	if x != nil {
		return x.SpaceId
	}
	return ""
...
func (x *UpsertMember) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *UpsertMember) GetRoleIds() []string {
	if x != nil {
		return x.RoleIds
	}
	return nil
...
var file_proto_types_request_member_manage_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x49, 0x64, 0x73, 0x22, 0x8f, 0x01, 0x0a, 0x0c, 0x55, 0x70, 0x73, 0x65, 0x72,
	0x74, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x2e, 0x0a, 0x08, 0x73, 0x70, 0x61, 0x63, 0x65,
	...
	0xc2, 0x01, 0x03, 0x88, 0x02, 0x41, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x28,
	0x0a, 0x08, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09,
	0x42, 0x0d, 0xe2, 0xdf, 0x1f, 0x09, 0x12, 0x07, 0xea, 0x01, 0x04, 0x30, 0x00, 0x38, 0x0a, 0x52,
	0x07, 0x72, 0x6f, 0x6c, 0x65, 0x49, 0x64, 0x73, 0x42, 0x74, 0x0a, 0x24, 0x63, 0x6f, 0x6d, 0x2e,
	...
	0x42, 0x15, 0x50, 0x42, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x4d, 0x65, 0x6d, 0x62, 0x65,
	0x72, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x50, 0x00, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_proto_types_request_member_manage_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_types_request_member_manage_proto_goTypes = []interface{}{
	...
	(*UpsertMember)(nil),    // 3: request.UpsertMember
}
