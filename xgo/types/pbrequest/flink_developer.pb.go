...
type SubmitFlinkJobInteractive struct {
	...
	IsChangelog bool `protobuf:"varint,4,opt,name=is_changelog,json=isChangelog,proto3" json:"is_changelog"`
}
...
func (x *SubmitFlinkJobInteractive) GetIsChangelog() bool {
	if x != nil {
		return x.IsChangelog
	}
	return false
}
...
var file_proto_types_request_flink_developer_proto_rawDesc = []byte{
	...
	0xdf, 0x1f, 0x00, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0xec, 0x01, 0x0a, 0x19, 0x53, 0x75,
	...
	0x65, 0x72, 0x76, 0x61, 0x6c, 0x12, 0x21, 0x0a, 0x0c, 0x69, 0x73, 0x5f, 0x63, 0x68, 0x61, 0x6e,
	0x67, 0x65, 0x6c, 0x6f, 0x67, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x69, 0x73, 0x43,
	0x68, 0x61, 0x6e, 0x67, 0x65, 0x6c, 0x6f, 0x67, 0x22, 0x3c, 0x0a, 0x10, 0x56, 0x61, 0x6c, 0x69,
