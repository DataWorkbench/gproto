...
var file_proto_types_request_flink_developer_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x3c, 0x0a, 0x10, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74,
...
var file_proto_types_request_flink_developer_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_types_request_flink_developer_proto_goTypes = []interface{}{
	...
	(*pbmodel.StreamJobArgs)(nil), // 3: model.StreamJobArgs
	(*pbmodel.StreamJobCode)(nil), // 4: model.StreamJobCode
}
var file_proto_types_request_flink_developer_proto_depIdxs = []int32{
	3, // 0: request.SubmitFlinkJob.args:type_name -> model.StreamJobArgs
	4, // 1: request.SubmitFlinkJob.code:type_name -> model.StreamJobCode
	4, // 2: request.ValidateFlinkJob.code:type_name -> model.StreamJobCode
