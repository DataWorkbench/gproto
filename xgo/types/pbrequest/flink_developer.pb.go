...
type SubmitFlinkJobInteractive struct {
	...
	Code *pbmodel.StreamJobCode `protobuf:"bytes,6,opt,name=code,proto3" json:"code"`
	// cancel
	CancelJob bool `protobuf:"varint,7,opt,name=cancel_job,json=cancelJob,proto3" json:"cancel_job"`
}
...
func (x *SubmitFlinkJobInteractive) GetFlinkId() string {
	if x != nil {
		return x.FlinkId
	}
	return ""
...
func (x *SubmitFlinkJobInteractive) GetFlinkUrl() string {
	if x != nil {
		return x.FlinkUrl
	}
	return ""
...
func (x *SubmitFlinkJobInteractive) GetFlinkVersion() string {
	if x != nil {
		return x.FlinkVersion
	}
	return ""
...
func (x *SubmitFlinkJobInteractive) GetSavepointPath() string {
	if x != nil {
		return x.SavepointPath
	}
	return ""
...
func (x *SubmitFlinkJobInteractive) GetArgs() *pbmodel.StreamJobArgs {
	if x != nil {
		return x.Args
	}
	return nil
...
func (x *SubmitFlinkJobInteractive) GetCode() *pbmodel.StreamJobCode {
	if x != nil {
		return x.Code
	}
	return nil
...
func (x *SubmitFlinkJobInteractive) GetCancelJob() bool {
	if x != nil {
		return x.CancelJob
	}
	return false
...
var file_proto_types_request_flink_developer_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x22, 0xd2, 0x02, 0x0a, 0x19, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x46, 0x6c, 0x69,
	...
	,
	...
	0x64, 0x65, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x42, 0x76, 0x0a, 0x24, 0x63, 0x6f, 0x6d, 0x2e,
	...
	0x42, 0x17, 0x50, 0x42, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x46, 0x6c, 0x69, 0x6e, 0x6b,
	0x44, 0x65, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x72, 0x50, 0x00, 0x5a, 0x33, 0x67, 0x69, 0x74,
...
var file_proto_types_request_flink_developer_proto_goTypes = []interface{}{
	...
	(*ExecuteFlinkSql)(nil),           // 2: request.ExecuteFlinkSql
...
var file_proto_types_request_flink_developer_proto_depIdxs = []int32{
	...
	4, // 2: request.SubmitFlinkJobInteractive.args:type_name -> model.StreamJobArgs
	5, // 3: request.SubmitFlinkJobInteractive.code:type_name -> model.StreamJobCode
