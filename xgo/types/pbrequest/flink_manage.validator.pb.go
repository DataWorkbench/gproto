...
var _xxx_xxx_Validator_ListAvailableFlinkVersions_InEnums_SourceKind = map[ListAvailableFlinkVersions_SourceKind]bool{0: true, 1: true, 2: true}

func (this *ListAvailableFlinkVersions) _xxx_xxx_Validator_Validate_source_kind() error {
	if !(_xxx_xxx_Validator_ListAvailableFlinkVersions_InEnums_SourceKind[this.SourceKind]) {
		return protovalidator.FieldError1("ListAvailableFlinkVersions", "the value of field 'source_kind' must in enums of '[0 1 2]'", protovalidator.Int32ToString(int32(this.SourceKind)))
	}
	return nil
}
...
func (this *ListAvailableFlinkVersions) Validate() error {
	...
	if err := this._xxx_xxx_Validator_Validate_source_kind(); err != nil {
		return err
	}
	return nil
}
...
func (this *RestartFlinkClusters) _xxx_xxx_Validator_Validate_space_id() error {
	if !(len(this.SpaceId) == 20) {
		return protovalidator.FieldError1("RestartFlinkClusters", "the byte length of field 'space_id' must be equal to '20'", protovalidator.StringByteLenToString(this.SpaceId))
	}
	if !(strings.HasPrefix(this.SpaceId, "wks-")) {
		return protovalidator.FieldError1("RestartFlinkClusters", "the value of field 'space_id' must start with string 'wks-'", this.SpaceId)
	}
	return nil
}

func (this *RestartFlinkClusters) _xxx_xxx_Validator_Validate_cluster_ids() error {
	if !(len(this.ClusterIds) > 0) {
		return protovalidator.FieldError1("RestartFlinkClusters", "the length of field 'cluster_ids' must be greater than '0'", strconv.Itoa(len(this.ClusterIds)))
	}
	if !(len(this.ClusterIds) <= 100) {
		return protovalidator.FieldError1("RestartFlinkClusters", "the length of field 'cluster_ids' must be less than or equal to '100'", strconv.Itoa(len(this.ClusterIds)))
	}
	for _, item := range this.ClusterIds {
		_ = item // To avoid unused panics.
		if !(strings.HasPrefix(item, "cfi-")) {
			return protovalidator.FieldError1("RestartFlinkClusters", "the value of array item where in field 'cluster_ids' must start with string 'cfi-'", item)
		}
	}
	return nil
}
...
func (this *RestartFlinkClusters) Validate() error {
	if this == nil {
		return nil
	}
	if err := this._xxx_xxx_Validator_Validate_space_id(); err != nil {
...
var _xxx_xxx_Validator_CreateFlinkCluster_In_Version = map[string]bool{"flink-1.12.3-scala_2.11": true, "flink-1.12.3-scala_2.11-q0.9": true, "flink-1.12.3-scala_2.11-cj_1.12": true, "flink-1.14.5-scala_2.11": true}
...
func (this *CreateFlinkCluster) _xxx_xxx_Validator_Validate_version() error {
	if !(_xxx_xxx_Validator_CreateFlinkCluster_In_Version[this.Version]) {
		return protovalidator.FieldError1("CreateFlinkCluster", "the value of field 'version' must be one of '[flink-1.12.3-scala_2.11 flink-1.12.3-scala_2.11-q0.9 flink-1.12.3-scala_2.11-cj_1.12 flink-1.14.5-scala_2.11]'", this.Version)
	}
	return nil
}
...
func (this *UpdateFlinkClusterStatusByScheduler) _xxx_xxx_Validator_Validate_cluster_id() error {
	if !(len(this.ClusterId) == 20) {
		return protovalidator.FieldError1("UpdateFlinkClusterStatusByScheduler", "the byte length of field 'cluster_id' must be equal to '20'", protovalidator.StringByteLenToString(this.ClusterId))
	}
	if !(strings.HasPrefix(this.ClusterId, "cfi-")) {
		return protovalidator.FieldError1("UpdateFlinkClusterStatusByScheduler", "the value of field 'cluster_id' must start with string 'cfi-'", this.ClusterId)
	}
	return nil
}

// Set default value for message request.UpdateFlinkClusterStatusByScheduler
func (this *UpdateFlinkClusterStatusByScheduler) Validate() error {
	if this == nil {
		return nil
	}
	if err := this._xxx_xxx_Validator_Validate_cluster_id(); err != nil {
...
func (this *StopFlinkClusterByScheduler) _xxx_xxx_Validator_Validate_space_id() error {
	if !(len(this.SpaceId) == 20) {
		return protovalidator.FieldError1("StopFlinkClusterByScheduler", "the byte length of field 'space_id' must be equal to '20'", protovalidator.StringByteLenToString(this.SpaceId))
	}
	if !(strings.HasPrefix(this.SpaceId, "wks-")) {
		return protovalidator.FieldError1("StopFlinkClusterByScheduler", "the value of field 'space_id' must start with string 'wks-'", this.SpaceId)
	}
	return nil
}

func (this *StopFlinkClusterByScheduler) _xxx_xxx_Validator_Validate_cluster_id() error {
	if !(len(this.ClusterId) == 20) {
		return protovalidator.FieldError1("StopFlinkClusterByScheduler", "the byte length of field 'cluster_id' must be equal to '20'", protovalidator.StringByteLenToString(this.ClusterId))
	}
	if !(strings.HasPrefix(this.ClusterId, "cfi-")) {
		return protovalidator.FieldError1("StopFlinkClusterByScheduler", "the value of field 'cluster_id' must start with string 'cfi-'", this.ClusterId)
	}
	return nil
}

// Set default value for message request.StopFlinkClusterByScheduler
func (this *StopFlinkClusterByScheduler) Validate() error {
	if this == nil {
		return nil
	}
	if err := this._xxx_xxx_Validator_Validate_space_id(); err != nil {
