...
var file_proto_types_request_dataservice_manage_proto_rawDesc = []byte{
	...
	,
...
var file_proto_types_request_dataservice_manage_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_proto_types_request_dataservice_manage_proto_goTypes = []interface{}{
	...
	(*TestCustomerApi)(nil),                         // 20: request.TestCustomerApi
	(pbmodel.DataServiceCluster_ResourceSpec)(0),    // 21: model.DataServiceCluster.ResourceSpec
	(pbmodel.ApiConfig_ApiMode)(0),                  // 22: model.ApiConfig.ApiMode
	(pbmodel.ApiConfig_Protocols)(0),                // 23: model.ApiConfig.Protocols
	(pbmodel.ApiConfig_RequestMethod)(0),            // 24: model.ApiConfig.RequestMethod
	(pbmodel.ApiConfig_ResponseType)(0),             // 25: model.ApiConfig.ResponseType
	(pbmodel.ParameterDataType)(0),                  // 26: model.ParameterDataType
	(pbmodel.ApiRequestParams_ParameterOperator)(0), // 27: model.ApiRequestParams.ParameterOperator
	(pbmodel.ApiRequestParams_ParameterPosition)(0), // 28: model.ApiRequestParams.ParameterPosition
}
var file_proto_types_request_dataservice_manage_proto_depIdxs = []int32{
	21, // 0: request.UpdateDataServiceCluster.resource_spec:type_name -> model.DataServiceCluster.ResourceSpec
	21, // 1: request.CreateDataServiceCluster.resource_spec:type_name -> model.DataServiceCluster.ResourceSpec
	22, // 2: request.UpdateCustomerApi.api_mode:type_name -> model.ApiConfig.ApiMode
	23, // 3: request.UpdateCustomerApi.protocols:type_name -> model.ApiConfig.Protocols
	24, // 4: request.UpdateCustomerApi.request_method:type_name -> model.ApiConfig.RequestMethod
	25, // 5: request.UpdateCustomerApi.response_type:type_name -> model.ApiConfig.ResponseType
	13, // 6: request.UpdateCustomerApi.wizardDetails:type_name -> request.WizardDetails
	22, // 7: request.CreateCustomerApi.api_mode:type_name -> model.ApiConfig.ApiMode
	23, // 8: request.CreateCustomerApi.protocols:type_name -> model.ApiConfig.Protocols
	24, // 9: request.CreateCustomerApi.request_method:type_name -> model.ApiConfig.RequestMethod
	25, // 10: request.CreateCustomerApi.response_type:type_name -> model.ApiConfig.ResponseType
	...
	26, // 14: request.WizardRequestParameters.data_type:type_name -> model.ParameterDataType
	27, // 15: request.WizardRequestParameters.param_operator:type_name -> model.ApiRequestParams.ParameterOperator
	28, // 16: request.WizardRequestParameters.param_position:type_name -> model.ApiRequestParams.ParameterPosition
	26, // 17: request.WizardResponseParameters.data_type:type_name -> model.ParameterDataType
