...
var file_proto_types_request_sync_job_manage_proto_rawDesc = []byte{
	...
	0x70, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x70, 0x69, 0x64, 0x22, 0xb7,
	0x03, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x79, 0x6e, 0x63, 0x4a, 0x6f, 0x62,
	...
	0x61, 0x63, 0x65, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x22, 0x74, 0x0a, 0x0e, 0x44, 0x65, 0x6c, 0x65,
...
var file_proto_types_request_sync_job_manage_proto_goTypes = []interface{}{
	...
	(pbmodel.DataSource_Type)(0),            // 24: model.DataSource.Type
}
var file_proto_types_request_sync_job_manage_proto_depIdxs = []int32{
	...
	21, // 1: request.SetSyncJobSchedule.schedule:type_name -> model.SyncJobSchedule
	22, // 2: request.SetSyncJobConf.conf:type_name -> model.SyncJobConf
	23, // 3: request.ListReleaseSyncJobs.status:type_name -> model.SyncJobRelease.Status
	20, // 4: request.ConvertSyncJobMode.type:type_name -> model.SyncJob.Type
	22, // 5: request.ConvertSyncJobMode.conf:type_name -> model.SyncJobConf
	24, // 6: request.GenerateJobJson.source_type:type_name -> model.DataSource.Type
	24, // 7: request.GenerateJobJson.target_type:type_name -> model.DataSource.Type
	20, // 8: request.GenerateJobJson.type:type_name -> model.SyncJob.Type
