...
var file_proto_types_response_flink_developer_proto_rawDesc = []byte{
	...
	0x72, 0x72, 0x65, 0x63, 0x74, 0x10, 0x02, 0x42, 0x79, 0x0a, 0x25, 0x63, 0x6f, 0x6d, 0x2e, 0x64,
	...
	0x42, 0x18, 0x50, 0x42, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x46, 0x6c, 0x69, 0x6e,
	0x6b, 0x44, 0x65, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x72, 0x50, 0x00, 0x5a, 0x34, 0x67, 0x69,
...
var file_proto_types_response_flink_developer_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_types_response_flink_developer_proto_goTypes = []interface{}{
	...
	(*GetFlinkJobsByUrl_FlinkJob)(nil), // 6: response.GetFlinkJobsByUrl.FlinkJob
	(pbflink.FlinkJob_Status)(0),       // 7: flink.FlinkJob.Status
}
var file_proto_types_response_flink_developer_proto_depIdxs = []int32{
	...
	7, // 1: response.GetFlinkJobStatus.status:type_name -> flink.FlinkJob.Status
	6, // 2: response.GetFlinkJobsByUrl.jobs:type_name -> response.GetFlinkJobsByUrl.FlinkJob
