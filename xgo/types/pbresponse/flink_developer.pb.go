...
func (ValidateFlinkJob_Result) EnumDescriptor() ([]byte, []int) {
	return file_proto_types_response_flink_developer_proto_rawDescGZIP(), []int{4, 0}
}
...
func (x *ExecuteFlinkSql) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type GetFlinkJobStatus struct {
	...
	Status pbflink.FlinkJob_Status `protobuf:"varint,2,opt,name=status,proto3,enum=flink.FlinkJob_Status" json:"status"`
	// job message
...
func (x *GetFlinkJobStatus) GetIsExists() bool {
	if x != nil {
		return x.IsExists
	}
	return false
...
func (x *GetFlinkJobStatus) GetStatus() pbflink.FlinkJob_Status {
	if x != nil {
		return x.Status
	}
	return pbflink.FlinkJob_Status(0)
}

func (x *GetFlinkJobStatus) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type GetFlinkJobsByUrl struct {
	...
	// jobs message
	Jobs []*GetFlinkJobsByUrl_FlinkJob `protobuf:"bytes,1,rep,name=jobs,proto3" json:"jobs"`
}
...
func (x *GetFlinkJobsByUrl) GetJobs() []*GetFlinkJobsByUrl_FlinkJob {
	if x != nil {
		return x.Jobs
	}
	return nil
...
func (*ValidateFlinkJob) Descriptor() ([]byte, []int) {
	return file_proto_types_response_flink_developer_proto_rawDescGZIP(), []int{4}
}
...
type GetFlinkJobsByUrl_FlinkJob struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetFlinkJobsByUrl_FlinkJob) Reset() {
	*x = GetFlinkJobsByUrl_FlinkJob{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetFlinkJobsByUrl_FlinkJob) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetFlinkJobsByUrl_FlinkJob) ProtoMessage() {}

func (x *GetFlinkJobsByUrl_FlinkJob) ProtoReflect() protoreflect.Message {
	mi := &file_proto_types_response_flink_developer_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetFlinkJobsByUrl_FlinkJob.ProtoReflect.Descriptor instead.
func (*GetFlinkJobsByUrl_FlinkJob) Descriptor() ([]byte, []int) {
	return file_proto_types_response_flink_developer_proto_rawDescGZIP(), []int{3, 0}
}

func (x *GetFlinkJobsByUrl_FlinkJob) GetJid() string {
	if x != nil {
		return x.Jid
	}
	return ""
...
func (x *GetFlinkJobsByUrl_FlinkJob) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GetFlinkJobsByUrl_FlinkJob) GetState() string {
	if x != nil {
		return x.State
	}
	return ""
...
func (x *GetFlinkJobsByUrl_FlinkJob) GetStartTime() int64 {
	if x != nil {
		return x.StartTime
	}
	return 0
...
func (x *GetFlinkJobsByUrl_FlinkJob) GetEndTime() int64 {
	if x != nil {
		return x.EndTime
	}
	return 0
...
var file_proto_types_response_flink_developer_proto_rawDesc = []byte{
	...
	0x0a, 0x06, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x10, 0x02, 0x22, 0x31, 0x0a, 0x0f, 0x45, 0x78,
	0x65, 0x63, 0x75, 0x74, 0x65, 0x46, 0x6c, 0x69, 0x6e, 0x6b, 0x53, 0x71, 0x6c, 0x12, 0x1e, 0x0a,
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x04,
	0xe2, 0xdf, 0x1f, 0x00, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x86, 0x01,
	0x0a, 0x11, 0x47, 0x65, 0x74, 0x46, 0x6c, 0x69, 0x6e, 0x6b, 0x4a, 0x6f, 0x62, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x69, 0x73, 0x5f, 0x65, 0x78, 0x69, 0x73, 0x74, 0x73,
	...
	,
	...
	0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x9e, 0x01, 0x0a, 0x10, 0x56, 0x61,
	0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x46, 0x6c, 0x69, 0x6e, 0x6b, 0x4a, 0x6f, 0x62, 0x12, 0x39,
	0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x21,
	0x2e, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61,
	0x74, 0x65, 0x46, 0x6c, 0x69, 0x6e, 0x6b, 0x4a, 0x6f, 0x62, 0x2e, 0x52, 0x65, 0x73, 0x75, 0x6c,
	...
	0x6e, 0x63, 0x6f, 0x72, 0x72, 0x65, 0x63, 0x74, 0x10, 0x02, 0x42, 0x79, 0x0a, 0x25, 0x63, 0x6f,
	...
	0x6e, 0x73, 0x65, 0x42, 0x18, 0x50, 0x42, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x46,
	0x6c, 0x69, 0x6e, 0x6b, 0x44, 0x65, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x72, 0x50, 0x00, 0x5a,
...
var file_proto_types_response_flink_developer_proto_goTypes = []interface{}{
	...
	(*ExecuteFlinkSql)(nil),            // 3: response.ExecuteFlinkSql
	(*GetFlinkJobStatus)(nil),          // 4: response.GetFlinkJobStatus
	(*GetFlinkJobsByUrl)(nil),          // 5: response.GetFlinkJobsByUrl
	(*ValidateFlinkJob)(nil),           // 6: response.ValidateFlinkJob
	(*GetFlinkJobsByUrl_FlinkJob)(nil), // 7: response.GetFlinkJobsByUrl.FlinkJob
	(pbflink.FlinkJob_Status)(0),       // 8: flink.FlinkJob.Status
}
var file_proto_types_response_flink_developer_proto_depIdxs = []int32{
	...
	8, // 1: response.GetFlinkJobStatus.status:type_name -> flink.FlinkJob.Status
	7, // 2: response.GetFlinkJobsByUrl.jobs:type_name -> response.GetFlinkJobsByUrl.FlinkJob
	1, // 3: response.ValidateFlinkJob.result:type_name -> response.ValidateFlinkJob.Result
...
func file_proto_types_response_flink_developer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_types_response_flink_developer_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetFlinkJobsByUrl_FlinkJob); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
