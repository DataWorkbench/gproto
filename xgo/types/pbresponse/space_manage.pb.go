...
type DescribeWorkspace struct {
	...
	Info *pbmodel.Workspace `protobuf:"bytes,1,opt,name=info,proto3" json:"info"`
}
...
type CheckPermission struct {
	...
	Workspace *pbmodel.Workspace `protobuf:"bytes,1,opt,name=workspace,proto3" json:"workspace"`
}
...
func (x *CheckPermission) GetWorkspace() *pbmodel.Workspace {
	if x != nil {
		return x.Workspace
	}
	return nil
...
type DescribeWorkspaceConfig struct {
	...
	QuotaSet *pbmodel.QuotaSet `protobuf:"bytes,1,opt,name=quota_set,json=quotaSet,proto3" json:"quota_set"`
}

func (x *DescribeWorkspaceConfig) Reset() {
	*x = DescribeWorkspaceConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_types_response_space_manage_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DescribeWorkspaceConfig) Descriptor() ([]byte, []int) {
	return file_proto_types_response_space_manage_proto_rawDescGZIP(), []int{4}
}

func (x *DescribeWorkspaceConfig) GetQuotaSet() *pbmodel.QuotaSet {
	if x != nil {
		return x.QuotaSet
	}
	return nil
...
type DescribeNetworkConfig struct {
	...
	Router         *pbiaas.Router  `protobuf:"bytes,1,opt,name=router,proto3" json:"router"`
	Vxnets         []*pbiaas.VXNet `protobuf:"bytes,2,rep,name=vxnets,proto3" json:"vxnets"`
	DefaultVxnetId string          `protobuf:"bytes,3,opt,name=default_vxnet_id,json=defaultVxnetId,proto3" json:"default_vxnet_id"`
}

func (x *DescribeNetworkConfig) Reset() {
	*x = DescribeNetworkConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_types_response_space_manage_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DescribeNetworkConfig) Descriptor() ([]byte, []int) {
	return file_proto_types_response_space_manage_proto_rawDescGZIP(), []int{5}
}

func (x *DescribeNetworkConfig) GetRouter() *pbiaas.Router {
	if x != nil {
		return x.Router
	}
	return nil
...
func (x *DescribeNetworkConfig) GetVxnets() []*pbiaas.VXNet {
	if x != nil {
		return x.Vxnets
	}
	return nil
...
func (x *DescribeNetworkConfig) GetDefaultVxnetId() string {
	if x != nil {
		return x.DefaultVxnetId
	}
	return ""
}
...
var file_proto_types_response_space_manage_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x61, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x20, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x69,
	0x61, 0x61, 0x73, 0x2f, 0x76, 0x70, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1d, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c,
	0x2f, 0x71, 0x75, 0x6f, 0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x69, 0x0a, 0x0e,
	0x4c, 0x69, 0x73, 0x74, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x73, 0x12, 0x26,
	...
	,
	...
	,
...
var file_proto_types_response_space_manage_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_types_response_space_manage_proto_goTypes = []interface{}{
	...
	(*DescribeWorkspaceConfig)(nil), // 4: response.DescribeWorkspaceConfig
	(*DescribeNetworkConfig)(nil),   // 5: response.DescribeNetworkConfig
	(*pbmodel.Workspace)(nil),       // 6: model.Workspace
	(*pbmodel.QuotaSet)(nil),        // 7: model.QuotaSet
	(*pbiaas.Router)(nil),           // 8: iaas.Router
	(*pbiaas.VXNet)(nil),            // 9: iaas.VXNet
}
var file_proto_types_response_space_manage_proto_depIdxs = []int32{
	6, // 0: response.ListWorkspaces.infos:type_name -> model.Workspace
	6, // 1: response.DescribeWorkspace.info:type_name -> model.Workspace
	6, // 2: response.CheckPermission.workspace:type_name -> model.Workspace
	7, // 3: response.DescribeWorkspaceConfig.quota_set:type_name -> model.QuotaSet
	8, // 4: response.DescribeNetworkConfig.router:type_name -> iaas.Router
	9, // 5: response.DescribeNetworkConfig.vxnets:type_name -> iaas.VXNet
...
func file_proto_types_response_space_manage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_types_response_space_manage_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_types_response_space_manage_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
