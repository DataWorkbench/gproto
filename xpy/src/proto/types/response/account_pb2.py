...
_CREATENOTIFICATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='notification', full_name='response.CreateNotification.notification', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATENOTIFICATION = _descriptor.Descriptor(
  ...
  full_name='response.UpdateNotification',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='notification', full_name='response.UpdateNotification.notification', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DELETENOTIFICATION = _descriptor.Descriptor(
  ...
  full_name='response.DeleteNotification',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='notification', full_name='response.DeleteNotification.notification', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETNOTIFICATIONS = _descriptor.Descriptor(
  ...
  full_name='response.GetNotifications',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_CREATENOTIFICATION.fields_by_name['notification'].message_type = proto_dot_types_dot_model_dot_account__pb2._NOTIFICATION
_UPDATENOTIFICATION.fields_by_name['notification'].message_type = proto_dot_types_dot_model_dot_account__pb2._NOTIFICATION
_DELETENOTIFICATION.fields_by_name['notification'].message_type = proto_dot_types_dot_model_dot_account__pb2._NOTIFICATION
_GETNOTIFICATIONS.fields_by_name['notification_set'].message_type = proto_dot_types_dot_model_dot_account__pb2._NOTIFICATION
