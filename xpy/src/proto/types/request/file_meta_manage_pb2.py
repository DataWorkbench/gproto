...
_CREATEFILEPREPARE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='space_owner', full_name='request.CreateFilePrepare.space_owner', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='pid', full_name='request.CreateFilePrepare.pid', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='request.CreateFilePrepare.name', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='size', full_name='request.CreateFilePrepare.size', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='request.CreateFilePrepare.type', index=5,
