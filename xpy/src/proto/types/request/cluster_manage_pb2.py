...
_DELETEFLINKCLUSTERS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='cluster_ids', full_name='request.DeleteFlinkClusters.cluster_ids', index=0,
...
_STARTFLINKCLUSTERS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='cluster_ids', full_name='request.StartFlinkClusters.cluster_ids', index=0,
      number=1, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STOPFLINKCLUSTERS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='cluster_ids', full_name='request.StopFlinkClusters.cluster_ids', index=0,
      number=1, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DescribeFlinkClusterAPI = _reflection.GeneratedProtocolMessageType('DescribeFlinkClusterAPI', (_message.Message,), {
  ...
  '__module__' : 'proto.types.request.cluster_manage_pb2'
...
_CREATEFLINKCLUSTER.fields_by_name['host_aliases']._options = None
_CREATEFLINKCLUSTER.fields_by_name['config']._options = None
...
_UPDATEFLINKCLUSTER.fields_by_name['host_aliases']._options = None
_UPDATEFLINKCLUSTER.fields_by_name['config']._options = None
