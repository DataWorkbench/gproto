...
_DESCNOTIFICATIONLIST = _descriptor.Descriptor(
  ...
  full_name='request.DescNotificationList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='limit', full_name='request.DescNotificationList.limit', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='offset', full_name='request.DescNotificationList.offset', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='owner', full_name='request.DescNotificationList.owner', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='nf_list_ids', full_name='request.DescNotificationList.nf_list_ids', index=3,
...
_DESCNOTIFICATIONLIST.fields_by_name['limit']._options = None
_DESCNOTIFICATIONLIST.fields_by_name['offset']._options = None
_DESCNOTIFICATIONLIST.fields_by_name['nf_list_ids']._options = None
