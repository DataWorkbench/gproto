...
_CREATEUDF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='space_owner', full_name='request.CreateUDF.space_owner', index=8,
