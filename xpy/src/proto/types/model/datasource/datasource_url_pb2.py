...
_REDISURL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='redis_hosts', full_name='datasource.RedisURL.redis_hosts', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REDISURL.fields_by_name['redis_hosts'].message_type = _HOST
...
_REDISURL.fields_by_name['redis_hosts']._options = None
