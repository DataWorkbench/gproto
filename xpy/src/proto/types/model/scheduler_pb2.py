...
_STREAMJOBQUEUE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='flink_url', full_name='model.StreamJobQueue.flink_url', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='flink_version', full_name='model.StreamJobQueue.flink_version', index=2,
      ...
      serialized_options=b'\342\337\037\007\022\005\302\001\002\"\000', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='retries', full_name='model.StreamJobQueue.retries', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='started', full_name='model.StreamJobQueue.started', index=4,
...
_STREAMJOBQUEUE.fields_by_name['flink_url']._options = None
_STREAMJOBQUEUE.fields_by_name['flink_version']._options = None
