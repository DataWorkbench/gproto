...
_FLINKTABLE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='create_by', full_name='model.FlinkTable.create_by', index=11,
...
_FLINKTABLE.fields_by_name['create_by']._options = None
