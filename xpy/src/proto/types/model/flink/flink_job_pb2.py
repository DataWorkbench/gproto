...
_FLINKPYTHONCODE = _descriptor.Descriptor(
  name='FlinkPythonCode',
  full_name='flink.FlinkPythonCode',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='flink.FlinkPythonCode.code', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FLINKPYTHONFILE = _descriptor.Descriptor(
  name='FlinkPythonFile',
  full_name='flink.FlinkPythonFile',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='python_path', full_name='flink.FlinkPythonFile.python_path', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342\337\037\017\022\r\302\001\n\230\002\024\312\002\004res-', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='python_module', full_name='flink.FlinkPythonFile.python_module', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342\337\037\014\022\n\302\001\007\230\002\200\010\210\005\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='python_args', full_name='flink.FlinkPythonFile.python_args', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342\337\037\014\022\n\302\001\007\230\002\200\010\210\005\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='delete_file_id', full_name='flink.FlinkPythonFile.delete_file_id', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['FlinkPythonCode'] = _FLINKPYTHONCODE
DESCRIPTOR.message_types_by_name['FlinkPythonFile'] = _FLINKPYTHONFILE
...
FlinkPythonCode = _reflection.GeneratedProtocolMessageType('FlinkPythonCode', (_message.Message,), {
  'DESCRIPTOR' : _FLINKPYTHONCODE,
  '__module__' : 'proto.types.model.flink.flink_job_pb2'
  # @@protoc_insertion_point(class_scope:flink.FlinkPythonCode)
  })
_sym_db.RegisterMessage(FlinkPythonCode)

FlinkPythonFile = _reflection.GeneratedProtocolMessageType('FlinkPythonFile', (_message.Message,), {
  'DESCRIPTOR' : _FLINKPYTHONFILE,
  '__module__' : 'proto.types.model.flink.flink_job_pb2'
  # @@protoc_insertion_point(class_scope:flink.FlinkPythonFile)
  })
_sym_db.RegisterMessage(FlinkPythonFile)
...
_FLINKPYTHONCODE.fields_by_name['code']._options = None
_FLINKPYTHONFILE.fields_by_name['python_path']._options = None
_FLINKPYTHONFILE.fields_by_name['python_module']._options = None
_FLINKPYTHONFILE.fields_by_name['python_args']._options = None
_FLINKPYTHONFILE.fields_by_name['delete_file_id']._options = None
