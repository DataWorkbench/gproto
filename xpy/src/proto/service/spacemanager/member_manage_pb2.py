...
_MEMBERMANAGE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='spacemanager.MemberManage.ListAvailableUsers',
    index=0,
    containing_service=None,
    input_type=proto_dot_types_dot_request_dot_member__manage__pb2._LISTAVAILABLEUSERS,
    output_type=proto_dot_types_dot_response_dot_member__manage__pb2._LISTAVAILABLEUSERS,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
