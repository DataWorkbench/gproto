...
_SYNCJOBMANAGE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='spacemanager.SyncJobManage.DescribeDBAndTable',
    index=20,
    containing_service=None,
    input_type=proto_dot_types_dot_request_dot_sync__job__manage__pb2._DESCRIBEDBANDTABLE,
    output_type=proto_dot_types_dot_response_dot_sync__job__manage__pb2._DESCRIBEDBANDTABLE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
