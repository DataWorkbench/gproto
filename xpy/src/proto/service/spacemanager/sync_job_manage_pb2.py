...
_SYNCJOBMANAGE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='spacemanager.SyncJobManage.ReopenReleaseSyncJob',
    index=12,
    containing_service=None,
    input_type=proto_dot_types_dot_request_dot_sync__job__manage__pb2._REOPENRELEASESYNCJOB,
    output_type=proto_dot_types_dot_model_dot_empty__pb2._EMPTYSTRUCT,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='spacemanager.SyncJobManage.LoadSyncJobScheduleParameters',
    index=21,
    containing_service=None,
    input_type=proto_dot_types_dot_request_dot_sync__job__manage__pb2._LOADSYNCJOBSCHEDULEPARAMETERS,
    output_type=proto_dot_types_dot_response_dot_sync__job__manage__pb2._LOADSYNCJOBSCHEDULEPARAMETERS,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
