...
_STREAMJOBMANAGE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='spacemanager.StreamJobManage.ReopenReleaseStreamJob',
    index=16,
    containing_service=None,
    input_type=proto_dot_types_dot_request_dot_stream__job__manage__pb2._REOPENRELEASESTREAMJOB,
    output_type=proto_dot_types_dot_model_dot_empty__pb2._EMPTYSTRUCT,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
