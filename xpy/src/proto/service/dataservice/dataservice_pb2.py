...
_DATASERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='UpdateApiGroup',
    full_name='dataservice.DataService.UpdateApiGroup',
    index=11,
    containing_service=None,
    input_type=proto_dot_types_dot_request_dot_dataservice__manage__pb2._UPDATEAPIGROUP,
    output_type=proto_dot_types_dot_model_dot_empty__pb2._EMPTYSTRUCT,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    full_name='dataservice.DataService.DescribeApiGroup',
    index=12,
    containing_service=None,
    input_type=proto_dot_types_dot_request_dot_dataservice__manage__pb2._DESCRIBEAPIGROUP,
    output_type=proto_dot_types_dot_response_dot_dataservice__manage__pb2._DESCRIBEAPIGROUP,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='dataservice.DataService.UpdateApiBaseConfig',
    index=17,
    containing_service=None,
    input_type=proto_dot_types_dot_request_dot_dataservice__manage__pb2._UPDATEAPIBASECONFIG,
    output_type=proto_dot_types_dot_model_dot_empty__pb2._EMPTYSTRUCT,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
