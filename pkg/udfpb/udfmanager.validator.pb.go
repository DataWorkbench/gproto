...
func (this *CreateRequest) Validate() error {
	...
	if !(len(this.Usage) > -1) {
		return github_com_mwitkow_go_proto_validators.FieldError("Usage", fmt.Errorf(`value '%v' must have a length greater than '-1'`, this.Usage))
	}
	return nil
}
...
func (this *InfoReply) Validate() error {
	...
	if !(len(this.Usage) < -1) {
		return github_com_mwitkow_go_proto_validators.FieldError("Usage", fmt.Errorf(`value '%v' must have a length smaller than '-1'`, this.Usage))
	}
	return nil
}
