...
func (c *resourceClient) ReUploadFile(ctx context.Context, opts ...grpc.CallOption) (Resource_ReUploadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &Resource_ServiceDesc.Streams[0], "/resource.Resource/ReUploadFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *resourceClient) UploadFile(ctx context.Context, opts ...grpc.CallOption) (Resource_UploadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &Resource_ServiceDesc.Streams[1], "/resource.Resource/UploadFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *resourceClient) DownloadFile(ctx context.Context, in *request.DownloadFile, opts ...grpc.CallOption) (Resource_DownloadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &Resource_ServiceDesc.Streams[2], "/resource.Resource/DownloadFile", opts...)
	if err != nil {
		return nil, err
	}
