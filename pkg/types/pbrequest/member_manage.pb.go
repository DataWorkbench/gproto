...
func (*UpsertMembers_Pair) Descriptor() ([]byte, []int) {
	return file_proto_types_request_member_manage_proto_rawDescGZIP(), []int{2, 0}
}
...
var file_proto_types_request_member_manage_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x1a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x79,
	...
	0x74, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x34, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x38, 0x64, 0x52, 0x07, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x73, 0x42, 0x74, 0x0a, 0x24, 0x63,
	...
	0x67, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x70, 0x62, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73,
...
var file_proto_types_request_member_manage_proto_goTypes = []interface{}{
	...
	(*UpsertMembers)(nil),      // 2: request.UpsertMembers
	(*DeleteMembers)(nil),      // 3: request.DeleteMembers
	(*UpsertMembers_Pair)(nil), // 4: request.UpsertMembers.Pair
}
var file_proto_types_request_member_manage_proto_depIdxs = []int32{
	4, // 0: request.UpsertMembers.users:type_name -> request.UpsertMembers.Pair
