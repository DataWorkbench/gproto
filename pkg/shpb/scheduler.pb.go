...
type SubmitStreamFlowRequest struct {
	...
	Meta        *model.StreamFlowMeta `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	StopRunning int32                 `protobuf:"varint,2,opt,name=stop_running,json=stopRunning,proto3" json:"stop_running,omitempty"`
}
...
func (x *SubmitStreamFlowRequest) GetStopRunning() int32 {
	if x != nil {
...
func (x *OfflineStreamFlowRequest) GetStopRunning() int32 {
	if x != nil {
		return x.StopRunning
	}
	return 0
...
var file_proto_scheduler_proto_rawDesc = []byte{
	...
	0x6e, 0x69, 0x6e, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x42, 0x11, 0xe2, 0xdf, 0x1f, 0x0d,
	...
	0x5f, 0x72, 0x75, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x42, 0x11,
