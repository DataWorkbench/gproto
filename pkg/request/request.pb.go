...
var file_proto_request_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xe2, 0xdf, 0x1f, 0x03, 0x80, 0x01, 0x14, 0x52, 0x07,
	0x53, 0x70, 0x61, 0x63, 0x65, 0x49, 0x44, 0x22, 0x91, 0x01, 0x0a, 0x10, 0x50, 0x54, 0x61, 0x73,
	...
	0x64, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_proto_request_proto_goTypes = []interface{}{
	...
	(*PTasksStatusStat)(nil),          // 72: request.PTasksStatusStat
	(*PTasksExecStat)(nil),            // 73: request.PTasksExecStat
	(*PTaskRuntimeRanking)(nil),       // 74: request.PTaskRuntimeRanking
	(*PTaskErrorRanking)(nil),         // 75: request.PTaskErrorRanking
	(*PTaskDispatchCount)(nil),        // 76: request.PTaskDispatchCount
