...
type CreateSource struct {
	...
	SourceType string `protobuf:"bytes,3,opt,name=source_type,json=sourceType,proto3" json:"source_type" binding:"gte=1,lte=20" required:"true" minLength:"1" maxLength:"20"`
...
type UpdateSource struct {
	...
	// Source Type one of MySQL/PostgreSQL/Kafka/S3/ClickHouse/Hbase/Ftp/HDFS
	SourceType string `protobuf:"bytes,2,opt,name=source_type,json=sourceType,proto3" json:"source_type" binding:"gte=1,lte=20" required:"true" minLength:"1" maxLength:"20"`
	// Source name unique within a space.
...
type PingSource struct {
	...
	// Source Type one of MySQL/PostgreSQL/Kafka/S3/ClickHouse/Hbase/Ftp/HDFS
	SourceType string `protobuf:"bytes,1,opt,name=source_type,json=sourceType,proto3" json:"source_type" binding:"gte=1,lte=20" required:"true" minLength:"1" maxLength:"20"`
	// this source connection info
...
type CreateTable struct {
	...
	Comment string `protobuf:"bytes,5,opt,name=comment,proto3" json:"comment" binding:"gte=0,lte=256" required:"false" minLength:"0" maxLength:"256"`
	// this source connection info
	Schema *flinkpb.TableSchema `protobuf:"bytes,6,opt,name=schema,proto3" json:"schema" binding:"gte=1,lte=8000" required:"true" minLength:"1" maxLength:"8000"`
	// source tablekind one of source/destination/dimension
	TableKind string `protobuf:"bytes,7,opt,name=table_kind,json=tableKind,proto3" json:"table_kind" binding:"gte=1,lte=16" required:"true" minLength:"1" maxLength:"16"`
}
...
func (x *CreateTable) GetSchema() *flinkpb.TableSchema {
	if x != nil {
		return x.Schema
	}
	return nil
...
func (x *CreateTable) GetTableKind() string {
	if x != nil {
		return x.TableKind
	}
	return ""
...
type UpdateTable struct {
	...
	// this source connection info
	Schema *flinkpb.TableSchema `protobuf:"bytes,4,opt,name=schema,proto3" json:"schema" binding:"gte=1,lte=8000" required:"true" minLength:"1" maxLength:"8000"`
	// source tablekind one of source/destination/dimension
	TableKind string `protobuf:"bytes,5,opt,name=table_kind,json=tableKind,proto3" json:"table_kind" binding:"gte=1,lte=16" required:"true" minLength:"1" maxLength:"16"`
}
...
func (x *UpdateTable) GetSchema() *flinkpb.TableSchema {
	if x != nil {
		return x.Schema
	}
	return nil
...
func (x *UpdateTable) GetTableKind() string {
	if x != nil {
		return x.TableKind
	}
	return ""
...
type ListTable struct {
	...
	TableKind string `protobuf:"bytes,8,opt,name=table_kind,json=tableKind,proto3" json:"table_kind" default:"source" form:"table_kind" binding:"gte=0,lte=16" required:"true" minLength:"0" maxLength:"16"`
}
...
func (x *ListTable) GetTableKind() string {
	if x != nil {
		return x.TableKind
	}
	return ""
...
var file_proto_request_proto_rawDesc = []byte{
	...
	,
	...
	0x03, 0x75, 0x72, 0x6c, 0x22, 0xd8, 0x01, 0x0a, 0x0c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x24, 0x0a, 0x09, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xe2, 0xdf, 0x1f, 0x03, 0x80, 0x01,
	0x14, 0x52, 0x08, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x12, 0x29, 0x0a, 0x0b, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x42, 0x08, 0xe2, 0xdf, 0x1f, 0x04, 0x70, 0x00, 0x78, 0x15, 0x52, 0x0a, 0x73, 0x6f, 0x75, 0x72,
	...
	0x72, 0x63, 0x65, 0x49, 0x64, 0x73, 0x22, 0x6f, 0x0a, 0x0a, 0x50, 0x69, 0x6e, 0x67, 0x53, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x12, 0x29, 0x0a, 0x0b, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x74,
	0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x08, 0xe2, 0xdf, 0x1f, 0x04, 0x70,
	...
	0x01, 0x14, 0x52, 0x08, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x22, 0x9b, 0x02, 0x0a,
	...
	0x02, 0x52, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x35, 0x0a, 0x06, 0x73, 0x63,
	...
	0xe2, 0xdf, 0x1f, 0x05, 0x70, 0x01, 0x78, 0xc1, 0x3e, 0x52, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d,
	0x61, 0x12, 0x27, 0x0a, 0x0a, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x6b, 0x69, 0x6e, 0x64, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x09, 0x42, 0x08, 0xe2, 0xdf, 0x1f, 0x04, 0x70, 0x01, 0x78, 0x11, 0x52,
	0x09, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x4b, 0x69, 0x6e, 0x64, 0x22, 0xd1, 0x01, 0x0a, 0x0b, 0x55,
	...
	,
	...
	0x09, 0x42, 0x07, 0xe2, 0xdf, 0x1f, 0x03, 0x80, 0x01, 0x14, 0x52, 0x07, 0x73, 0x70, 0x61, 0x63,
	0x65, 0x49, 0x64, 0x22, 0xac, 0x02, 0x0a, 0x09, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x61, 0x62, 0x6c,
	...
	0x01, 0x14, 0x52, 0x07, 0x73, 0x70, 0x61, 0x63, 0x65, 0x49, 0x64, 0x12, 0x23, 0x0a, 0x09, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06,
	0xe2, 0xdf, 0x1f, 0x02, 0x78, 0x15, 0x52, 0x08, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64,
	0x12, 0x30, 0x0a, 0x0a, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x6b, 0x69, 0x6e, 0x64, 0x18, 0x08,
	0x20, 0x01, 0x28, 0x09, 0x42, 0x11, 0xe2, 0xdf, 0x1f, 0x0d, 0x70, 0xff, 0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0x01, 0x78, 0x11, 0x52, 0x09, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x4b, 0x69,
	...
	0x76, 0x65, 0x72, 0x73, 0x65, 0x22, 0x92, 0x02, 0x0a, 0x0e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x63, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xe2,
	0xdf, 0x1f, 0x02, 0x20, 0x01, 0x52, 0x0c, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4e,
	0x61, 0x6d, 0x65, 0x12, 0x37, 0x0a, 0x14, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f,
	0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x04, 0xe2, 0xdf, 0x1f, 0x00, 0x52, 0x13, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4c, 0x0a, 0x0d,
	...
	0x65, 0x52, 0x0b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x73, 0x22, 0xb0,
	...
	0x23, 0x0a, 0x08, 0x75, 0x64, 0x66, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x08, 0xe2, 0xdf, 0x1f, 0x04, 0x70, 0x00, 0x78, 0x15, 0x52, 0x07, 0x75, 0x64, 0x66,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x2b, 0x0a, 0x0c, 0x75, 0x64, 0x66, 0x5f, 0x6c, 0x61, 0x6e, 0x67,
	0x75, 0x61, 0x67, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x08, 0xe2, 0xdf, 0x1f, 0x04,
	0x70, 0x00, 0x78, 0x15, 0x52, 0x0b, 0x75, 0x64, 0x66, 0x4c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67,
	...
	0xe2, 0xdf, 0x1f, 0x03, 0x80, 0x01, 0x14, 0x52, 0x05, 0x75, 0x64, 0x66, 0x49, 0x64, 0x22, 0xf9,
	0x01, 0x0a, 0x07, 0x4c, 0x69, 0x73, 0x74, 0x55, 0x44, 0x46, 0x12, 0x1f, 0x0a, 0x05, 0x6c, 0x69,
	...
	0x61, 0x63, 0x65, 0x49, 0x64, 0x12, 0x23, 0x0a, 0x08, 0x75, 0x64, 0x66, 0x5f, 0x74, 0x79, 0x70,
	0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x42, 0x08, 0xe2, 0xdf, 0x1f, 0x04, 0x70, 0x00, 0x78,
	0x15, 0x52, 0x07, 0x75, 0x64, 0x66, 0x54, 0x79, 0x70, 0x65, 0x22, 0x33, 0x0a, 0x0d, 0x55, 0x44,
	0x46, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x46, 0x75, 0x6e, 0x63, 0x12, 0x22, 0x0a, 0x08, 0x73,
	...
	0xaf, 0x01, 0x0a, 0x07, 0x4a, 0x6f, 0x62, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1e, 0x0a, 0x06, 0x6a,
	0x6f, 0x62, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xe2, 0xdf, 0x1f,
	0x03, 0x80, 0x01, 0x14, 0x52, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x64, 0x12, 0x22, 0x0a, 0x08, 0x73,
	0x70, 0x61, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xe2,
	0xdf, 0x1f, 0x03, 0x80, 0x01, 0x14, 0x52, 0x07, 0x73, 0x70, 0x61, 0x63, 0x65, 0x49, 0x64, 0x12,
	0x2f, 0x0a, 0x04, 0x61, 0x72, 0x67, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e,
	...
	0x12, 0x2f, 0x0a, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15,
	0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x46, 0x6c, 0x6f,
	0x77, 0x4e, 0x6f, 0x64, 0x65, 0x42, 0x04, 0xe2, 0xdf, 0x1f, 0x00, 0x52, 0x04, 0x6e, 0x6f, 0x64,
	0x65, 0x22, 0x2d, 0x0a, 0x0b, 0x4a, 0x6f, 0x62, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	0xdf, 0x1f, 0x03, 0x80, 0x01, 0x14, 0x52, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x64, 0x22, 0x2a, 0x0a,
	0x08, 0x4a, 0x6f, 0x62, 0x43, 0x6c, 0x65, 0x61, 0x6e, 0x12, 0x1e, 0x0a, 0x06, 0x6a, 0x6f, 0x62,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
