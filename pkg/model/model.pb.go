...
type SourceInfo struct {
	...
	SourceID string `protobuf:"bytes,1,opt,name=SourceID,proto3" json:"sourceid" gorm:"column:sourceid;primaryKey;"`
	// Space ID, workspace ID.
	SpaceID string `protobuf:"bytes,2,opt,name=SpaceID,proto3" json:"spaceid" gorm:"column:spaceid;"`
	...
	Url *SourceUrl `protobuf:"bytes,6,opt,name=Url,proto3" json:"url" gorm:"column:url;"`
	// State, one of enable/disable.
	State string `protobuf:"bytes,7,opt,name=State,proto3" json:"state" gorm:"column:state;"`
	// Create Time, this Source create time.
	CreateTime string `protobuf:"bytes,8,opt,name=CreateTime,proto3" json:"createtime" gorm:"column:createtime;"`
	// Update Time, this Source last update time.
	UpdateTime string `protobuf:"bytes,9,opt,name=UpdateTime,proto3" json:"updatetime" gorm:"column:updatetime;"`
}
...
func (x *SourceInfo) GetUpdateTime() string {
	if x != nil {
		return x.UpdateTime
	}
	return ""
...
type TableInfo struct {
	...
	TableID string `protobuf:"bytes,1,opt,name=TableID,proto3" json:"tableid" gorm:"column:tableid;primaryKey;"`
	// Source ID
	SourceID string `protobuf:"bytes,2,opt,name=SourceID,proto3" json:"sourceid" gorm:"column:sourceid;"`
	// Space ID, workspace ID.
	SpaceID string `protobuf:"bytes,3,opt,name=SpaceID,proto3" json:"spaceid" gorm:"column:spaceid;"`
	// Source Name, unique within a space.
	Name string `protobuf:"bytes,4,opt,name=Name,proto3" json:"name" gorm:"column:name;"`
	// Comment, describe this source.
	Comment string `protobuf:"bytes,5,opt,name=Comment,proto3" json:"comment" gorm:"column:comment;"`
	// Url, this source connection info.
	Url *TableUrl `protobuf:"bytes,6,opt,name=Url,proto3" json:"url" gorm:"column:url;"`
	// Create Time, this Source create time.
	CreateTime string `protobuf:"bytes,7,opt,name=CreateTime,proto3" json:"createtime" gorm:"column:createtime;"`
	// Update Time, this Source last update time.
	UpdateTime string `protobuf:"bytes,8,opt,name=UpdateTime,proto3" json:"updatetime" gorm:"column:updatetime;"`
	// Direction, one of source/destination/dimension
	Direction string `protobuf:"bytes,9,opt,name=Direction,proto3" json:"direction" gorm:"column:direction;"`
}
...
func (x *TableInfo) GetCreateTime() string {
	if x != nil {
		return x.CreateTime
	}
	return ""
...
func (x *TableInfo) GetUpdateTime() string {
	if x != nil {
		return x.UpdateTime
	}
	return ""
...
type SourceUrl struct {
	...
	//	*SourceUrl_MySQL
	//	*SourceUrl_PostgreSQL
	//	*SourceUrl_ClickHouse
	//	*SourceUrl_Kafka
	//	*SourceUrl_S3
	//	*SourceUrl_Hbase
	//	*SourceUrl_Ftp
	//	*SourceUrl_HDFS
	Source isSourceUrl_Source `protobuf_oneof:"Source"`
}
...
func (m *SourceUrl) GetSource() isSourceUrl_Source {
	if m != nil {
		return m.Source
	}
	return nil
...
func (x *SourceUrl) GetMySQL() *MySQLUrl {
	if x, ok := x.GetSource().(*SourceUrl_MySQL); ok {
		return x.MySQL
	}
	return nil
}
...
func (x *SourceUrl) GetPostgreSQL() *PostgreSQLUrl {
	if x, ok := x.GetSource().(*SourceUrl_PostgreSQL); ok {
		return x.PostgreSQL
	}
	return nil
}
...
func (x *SourceUrl) GetClickHouse() *ClickHouseUrl {
	if x, ok := x.GetSource().(*SourceUrl_ClickHouse); ok {
		return x.ClickHouse
	}
	return nil
}
...
func (x *SourceUrl) GetKafka() *KafkaUrl {
	if x, ok := x.GetSource().(*SourceUrl_Kafka); ok {
		return x.Kafka
	}
	return nil
}
...
func (x *SourceUrl) GetS3() *S3Url {
	if x, ok := x.GetSource().(*SourceUrl_S3); ok {
		return x.S3
	}
	return nil
}
...
func (x *SourceUrl) GetHbase() *HbaseUrl {
	if x, ok := x.GetSource().(*SourceUrl_Hbase); ok {
		return x.Hbase
	}
	return nil
}
...
func (x *SourceUrl) GetFtp() *FtpUrl {
	if x, ok := x.GetSource().(*SourceUrl_Ftp); ok {
		return x.Ftp
	}
	return nil
}
...
func (x *SourceUrl) GetHDFS() *HDFSUrl {
	if x, ok := x.GetSource().(*SourceUrl_HDFS); ok {
		return x.HDFS
	}
	return nil
}

type isSourceUrl_Source interface {
	isSourceUrl_Source()
}

type SourceUrl_MySQL struct {
	// MySQL Source Connection Info.
	MySQL *MySQLUrl `protobuf:"bytes,1,opt,name=MySQL,proto3,oneof" json:"mysql"`
}

type SourceUrl_PostgreSQL struct {
	// PostgreSQL Source Connection Info.
	PostgreSQL *PostgreSQLUrl `protobuf:"bytes,2,opt,name=PostgreSQL,proto3,oneof" json:"postgresql"`
}

type SourceUrl_ClickHouse struct {
	// ClickHouse Source Connection Info.
	ClickHouse *ClickHouseUrl `protobuf:"bytes,3,opt,name=ClickHouse,proto3,oneof" json:"clickhouse"`
}

type SourceUrl_Kafka struct {
	// Kafka Source Connection Info.
	Kafka *KafkaUrl `protobuf:"bytes,4,opt,name=Kafka,proto3,oneof" json:"kafka"`
}

type SourceUrl_S3 struct {
	// S3 Source Connection Info.
	S3 *S3Url `protobuf:"bytes,5,opt,name=S3,proto3,oneof" json:"s3"`
}

type SourceUrl_Hbase struct {
	// Hbase Source Connection Info.
	Hbase *HbaseUrl `protobuf:"bytes,6,opt,name=Hbase,proto3,oneof" json:"hbase"`
}

type SourceUrl_Ftp struct {
	// Ftp Source Connection Info.
	Ftp *FtpUrl `protobuf:"bytes,7,opt,name=Ftp,proto3,oneof" json:"ftp"`
}

type SourceUrl_HDFS struct {
	// HDFS Source Connection Info.
	HDFS *HDFSUrl `protobuf:"bytes,8,opt,name=HDFS,proto3,oneof" json:"hdfs"`
}

func (*SourceUrl_MySQL) isSourceUrl_Source() {}

func (*SourceUrl_PostgreSQL) isSourceUrl_Source() {}

func (*SourceUrl_ClickHouse) isSourceUrl_Source() {}

func (*SourceUrl_Kafka) isSourceUrl_Source() {}

func (*SourceUrl_S3) isSourceUrl_Source() {}

func (*SourceUrl_Hbase) isSourceUrl_Source() {}

func (*SourceUrl_Ftp) isSourceUrl_Source() {}

func (*SourceUrl_HDFS) isSourceUrl_Source() {}
...
type TableUrl struct {
	...
	//	*TableUrl_Ftp
	//	*TableUrl_HDFS
	Table isTableUrl_Table `protobuf_oneof:"Table"`
}
...
func (m *TableUrl) GetTable() isTableUrl_Table {
	if m != nil {
		return m.Table
	}
	return nil
...
func (x *TableUrl) GetMySQL() *MySQLTableUrl {
	if x, ok := x.GetTable().(*TableUrl_MySQL); ok {
		return x.MySQL
	}
	return nil
}
...
func (x *TableUrl) GetPostgreSQL() *PostgreSQLTableUrl {
	if x, ok := x.GetTable().(*TableUrl_PostgreSQL); ok {
		return x.PostgreSQL
	}
	return nil
}
...
func (x *TableUrl) GetClickHouse() *ClickHouseTableUrl {
	if x, ok := x.GetTable().(*TableUrl_ClickHouse); ok {
		return x.ClickHouse
	}
	return nil
}
...
func (x *TableUrl) GetHbase() *HbaseTableUrl {
	if x, ok := x.GetTable().(*TableUrl_Hbase); ok {
		return x.Hbase
	}
	return nil
}
...
func (x *TableUrl) GetKafka() *KafkaTableUrl {
	if x, ok := x.GetTable().(*TableUrl_Kafka); ok {
		return x.Kafka
	}
	return nil
}
...
func (x *TableUrl) GetS3() *S3TableUrl {
	if x, ok := x.GetTable().(*TableUrl_S3); ok {
		return x.S3
	}
	return nil
}
...
func (x *TableUrl) GetFtp() *FtpTableUrl {
	if x, ok := x.GetTable().(*TableUrl_Ftp); ok {
		return x.Ftp
	}
	return nil
}
...
func (x *TableUrl) GetHDFS() *HDFSTableUrl {
	if x, ok := x.GetTable().(*TableUrl_HDFS); ok {
		return x.HDFS
	}
	return nil
}

type isTableUrl_Table interface {
	isTableUrl_Table()
}

type TableUrl_MySQL struct {
	// MySQL Table Info.
	MySQL *MySQLTableUrl `protobuf:"bytes,1,opt,name=MySQL,proto3,oneof" json:"mysql"`
}

type TableUrl_PostgreSQL struct {
	// PostgreSQL Table Info.
	PostgreSQL *PostgreSQLTableUrl `protobuf:"bytes,2,opt,name=PostgreSQL,proto3,oneof" json:"postgresql"`
}

type TableUrl_ClickHouse struct {
	// ClickHouse Table Info.
	ClickHouse *ClickHouseTableUrl `protobuf:"bytes,3,opt,name=ClickHouse,proto3,oneof" json:"clickhouse"`
}

type TableUrl_Hbase struct {
	// Hbase Table Info.
	Hbase *HbaseTableUrl `protobuf:"bytes,4,opt,name=Hbase,proto3,oneof" json:"hbase"`
}

type TableUrl_Kafka struct {
	// Kafka Table Info.
	Kafka *KafkaTableUrl `protobuf:"bytes,5,opt,name=Kafka,proto3,oneof" json:"kafka"`
}

type TableUrl_S3 struct {
	// S3 Table Info.
	S3 *S3TableUrl `protobuf:"bytes,6,opt,name=S3,proto3,oneof" json:"s3"`
}

type TableUrl_Ftp struct {
	// Ftp Table Info.
	Ftp *FtpTableUrl `protobuf:"bytes,7,opt,name=Ftp,proto3,oneof" json:"ftp"`
}

type TableUrl_HDFS struct {
	// HDFS Table Info.
	HDFS *HDFSTableUrl `protobuf:"bytes,8,opt,name=HDFS,proto3,oneof" json:"hdfs"`
}

func (*TableUrl_MySQL) isTableUrl_Table() {}

func (*TableUrl_PostgreSQL) isTableUrl_Table() {}

func (*TableUrl_ClickHouse) isTableUrl_Table() {}

func (*TableUrl_Hbase) isTableUrl_Table() {}

func (*TableUrl_Kafka) isTableUrl_Table() {}

func (*TableUrl_S3) isTableUrl_Table() {}

func (*TableUrl_Ftp) isTableUrl_Table() {}
...
var file_proto_model_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x42, 0x06, 0xe2, 0xdf, 0x1f, 0x02, 0x78, 0x41, 0x52, 0x0a, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x26, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xe2, 0xdf, 0x1f,
	0x02, 0x78, 0x41, 0x52, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22,
	...
	0x54, 0x69, 0x6d, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xe2, 0xdf, 0x1f, 0x02,
	0x78, 0x41, 0x52, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x26,
	0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x09, 0x42, 0x06, 0xe2, 0xdf, 0x1f, 0x02, 0x78, 0x41, 0x52, 0x0a, 0x55, 0x70, 0x64, 0x61,
	...
	0x61, 0x6c, 0x75, 0x65, 0x22, 0xb0, 0x01, 0x0a, 0x08, 0x4d, 0x79, 0x53, 0x51, 0x4c, 0x55, 0x72,
	...
	,
	...
	0x08, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x12, 0x1c, 0x0a, 0x04, 0x50, 0x6f, 0x72,
	0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x42, 0x08, 0xe2, 0xdf, 0x1f, 0x04, 0x70, 0x00, 0x78,
	0x41, 0x52, 0x04, 0x50, 0x6f, 0x72, 0x74, 0x22, 0x39, 0x0a, 0x08, 0x4b, 0x61, 0x66, 0x6b, 0x61,
	0x55, 0x72, 0x6c, 0x12, 0x2d, 0x0a, 0x0c, 0x4b, 0x61, 0x66, 0x6b, 0x61, 0x42, 0x72, 0x6f, 0x6b,
	0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x09, 0xe2, 0xdf, 0x1f, 0x05, 0x70,
	0x00, 0x78, 0x81, 0x08, 0x52, 0x0c, 0x4b, 0x61, 0x66, 0x6b, 0x61, 0x42, 0x72, 0x6f, 0x6b, 0x65,
	0x72, 0x73, 0x22, 0x80, 0x01, 0x0a, 0x05, 0x53, 0x33, 0x55, 0x72, 0x6c, 0x12, 0x27, 0x0a, 0x09,
	...
	,
	...
	,
	...
	,
	...
	0x22, 0xcd, 0x01, 0x0a, 0x12, 0x50, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x53, 0x51, 0x4c, 0x54,
	0x61, 0x62, 0x6c, 0x65, 0x55, 0x72, 0x6c, 0x12, 0x38, 0x0a, 0x09, 0x53, 0x71, 0x6c, 0x43, 0x6f,
	0x6c, 0x75, 0x6d, 0x6e, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x2e, 0x53, 0x71, 0x6c, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x54, 0x79, 0x70, 0x65,
	0x42, 0x04, 0xe2, 0xdf, 0x1f, 0x00, 0x52, 0x09, 0x53, 0x71, 0x6c, 0x43, 0x6f, 0x6c, 0x75, 0x6d,
	...
	0x6f, 0x72, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x04, 0xe2, 0xdf, 0x1f, 0x00, 0x52, 0x10,
	0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x22, 0xcd, 0x01, 0x0a, 0x12, 0x43, 0x6c, 0x69, 0x63, 0x6b, 0x48, 0x6f, 0x75, 0x73, 0x65, 0x54,
	0x61, 0x62, 0x6c, 0x65, 0x55, 0x72, 0x6c, 0x12, 0x38, 0x0a, 0x09, 0x53, 0x71, 0x6c, 0x43, 0x6f,
	0x6c, 0x75, 0x6d, 0x6e, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x2e, 0x53, 0x71, 0x6c, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x54, 0x79, 0x70, 0x65,
	0x42, 0x04, 0xe2, 0xdf, 0x1f, 0x00, 0x52, 0x09, 0x53, 0x71, 0x6c, 0x43, 0x6f, 0x6c, 0x75, 0x6d,
	...
	0x6f, 0x72, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x04, 0xe2, 0xdf, 0x1f, 0x00, 0x52, 0x10,
	0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x22, 0xc8, 0x01, 0x0a, 0x0d, 0x48, 0x62, 0x61, 0x73, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x55,
	...
	0x63, 0x74, 0x6f, 0x72, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xd3, 0x01, 0x0a, 0x0c,
	0x48, 0x44, 0x46, 0x53, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x55, 0x72, 0x6c, 0x12, 0x38, 0x0a, 0x09,
	...
	0x73, 0x22, 0xd1, 0x01, 0x0a, 0x0a, 0x53, 0x33, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x55, 0x72, 0x6c,
	...
	0x09, 0x53, 0x71, 0x6c, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x12, 0x20, 0x0a, 0x06, 0x46, 0x6f,
	0x72, 0x6d, 0x61, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x08, 0xe2, 0xdf, 0x1f, 0x04,
	0x70, 0x00, 0x78, 0x41, 0x52, 0x06, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12, 0x1d, 0x0a, 0x04,
	0x50, 0x61, 0x74, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x09, 0xe2, 0xdf, 0x1f, 0x05,
	0x70, 0x00, 0x78, 0x81, 0x08, 0x52, 0x04, 0x50, 0x61, 0x74, 0x68, 0x12, 0x48, 0x0a, 0x10, 0x43,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xd2, 0x01, 0x0a, 0x0b, 0x46, 0x74, 0x70, 0x54, 0x61, 0x62,
	...
	,
	...
	,
...
func file_proto_model_proto_init() {
	...
	file_proto_model_proto_msgTypes[34].OneofWrappers = []interface{}{
		(*SourceUrl_MySQL)(nil),
		(*SourceUrl_PostgreSQL)(nil),
		(*SourceUrl_ClickHouse)(nil),
		(*SourceUrl_Kafka)(nil),
		(*SourceUrl_S3)(nil),
		(*SourceUrl_Hbase)(nil),
		(*SourceUrl_Ftp)(nil),
	...
	file_proto_model_proto_msgTypes[43].OneofWrappers = []interface{}{
		(*TableUrl_MySQL)(nil),
		(*TableUrl_PostgreSQL)(nil),
		(*TableUrl_ClickHouse)(nil),
		(*TableUrl_Hbase)(nil),
		(*TableUrl_Kafka)(nil),
		(*TableUrl_S3)(nil),
		(*TableUrl_Ftp)(nil),
