...
var file_proto_model_proto_rawDesc = []byte{
	...
	0x0d, 0x0a, 0x09, 0x44, 0x69, 0x6d, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x10, 0x03, 0x22, 0x9f,
	...
	0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x70, 0x69, 0x64, 0x12, 0x19, 0x0a,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x28, 0x0a, 0x04,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x54, 0x79, 0x70, 0x65,
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x65,
	...
	0xff, 0x01, 0x78, 0x81, 0x08, 0x52, 0x03, 0x6a, 0x61, 0x72, 0x22, 0x98, 0x02, 0x0a, 0x07, 0x4e,
	...
	0x79, 0x12, 0x20, 0x0a, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x18, 0x07, 0x20, 0x01,
	...
	0x64, 0x61, 0x74, 0x65, 0x64, 0x22, 0x8a, 0x01, 0x0a, 0x0b, 0x48, 0x6f, 0x73, 0x74, 0x41, 0x6c,
	...
	0x0a, 0x00, 0x22, 0xb4, 0x05, 0x0a, 0x0c, 0x46, 0x6c, 0x69, 0x6e, 0x6b, 0x43, 0x6c, 0x75, 0x73,
	...
	0x69, 0x67, 0x12, 0x15, 0x0a, 0x06, 0x77, 0x65, 0x62, 0x5f, 0x75, 0x69, 0x18, 0x0c, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x77, 0x65, 0x62, 0x55, 0x69, 0x12, 0x25, 0x0a, 0x0a, 0x63, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x64, 0x5f, 0x62, 0x79, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xe2,
	...
	0x61, 0x74, 0x65, 0x64, 0x22, 0x53, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x05,
	...
	0x09, 0x45, 0x78, 0x63, 0x65, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x10, 0x04, 0x12, 0x0b, 0x0a, 0x07,
	0x41, 0x72, 0x72, 0x65, 0x61, 0x72, 0x73, 0x10, 0x05, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74,
...
var file_proto_model_proto_enumTypes = make([]protoimpl.EnumInfo, 23)
...
var file_proto_model_proto_goTypes = []interface{}{
	...
	(UDFInfo_Type)(0),                        // 20: model.UDFInfo.Type
	(UDFInfo_Language)(0),                    // 21: model.UDFInfo.Language
	(FlinkCluster_Status)(0),                 // 22: model.FlinkCluster.Status
	(*EmptyStruct)(nil),                      // 23: model.EmptyStruct
	(*Error)(nil),                            // 24: model.Error
	(*Workspace)(nil),                        // 25: model.Workspace
	(*StreamJob)(nil),                        // 26: model.StreamJob
	(*StreamJobProperty)(nil),                // 27: model.StreamJobProperty
	(*StreamJobCode)(nil),                    // 28: model.StreamJobCode
	(*StreamJobArgs)(nil),                    // 29: model.StreamJobArgs
	(*StreamJobSchedule)(nil),                // 30: model.StreamJobSchedule
	(*StreamJobRelease)(nil),                 // 31: model.StreamJobRelease
	(*StreamJobInst)(nil),                    // 32: model.StreamJobInst
	(*Operation)(nil),                        // 33: model.Operation
	(*Role)(nil),                             // 34: model.Role
	(*Member)(nil),                           // 35: model.Member
	(*MonitorRule)(nil),                      // 36: model.MonitorRule
	(*QueueMessage)(nil),                     // 37: model.QueueMessage
	(*InstanceStatusStat)(nil),               // 38: model.InstanceStatusStat
	(*InstanceRuntimeRankInfo)(nil),          // 39: model.InstanceRuntimeRankInfo
	(*InstanceErrorRankInfo)(nil),            // 40: model.InstanceErrorRankInfo
	(*DispatchTaskCountInfo)(nil),            // 41: model.DispatchTaskCountInfo
	(*InstanceTaskExecStat)(nil),             // 42: model.InstanceTaskExecStat
	(*DataSource)(nil),                       // 43: model.DataSource
	(*TableInfo)(nil),                        // 44: model.TableInfo
	(*Resource)(nil),                         // 45: model.Resource
	(*UDFInfo)(nil),                          // 46: model.UDFInfo
	(*JobResources)(nil),                     // 47: model.JobResources
	(*Network)(nil),                          // 48: model.Network
	(*HostAliases)(nil),                      // 49: model.HostAliases
	(*FlinkCluster)(nil),                     // 50: model.FlinkCluster
	(*StreamJobArgs_Function)(nil),           // 51: model.StreamJobArgs.Function
	(*HostAliases_Item)(nil),                 // 52: model.HostAliases.Item
	(*flinkpb.FlinkOperator)(nil),            // 53: flink.FlinkOperator
	(*flinkpb.FlinkSQL)(nil),                 // 54: flink.FlinkSQL
	(*flinkpb.FlinkJar)(nil),                 // 55: flink.FlinkJar
	(*flinkpb.FlinkScala)(nil),               // 56: flink.FlinkScala
	(*flinkpb.FlinkPython)(nil),              // 57: flink.FlinkPython
	(*datasourcepb.DataSourceURL)(nil),       // 58: datasource.DataSourceURL
	(*flinkpb.TableSchema)(nil),              // 59: flink.TableSchema
	(*flinkpb.FlinkConfig)(nil),              // 60: flink.FlinkConfig
}
var file_proto_model_proto_depIdxs = []int32{
	...
	28, // 3: model.StreamJobProperty.code:type_name -> model.StreamJobCode
	29, // 4: model.StreamJobProperty.args:type_name -> model.StreamJobArgs
	30, // 5: model.StreamJobProperty.schedule:type_name -> model.StreamJobSchedule
	1,  // 6: model.StreamJobCode.type:type_name -> model.StreamJob.Type
	53, // 7: model.StreamJobCode.operators:type_name -> flink.FlinkOperator
	54, // 8: model.StreamJobCode.sql:type_name -> flink.FlinkSQL
	55, // 9: model.StreamJobCode.jar:type_name -> flink.FlinkJar
	56, // 10: model.StreamJobCode.scala:type_name -> flink.FlinkScala
	57, // 11: model.StreamJobCode.python:type_name -> flink.FlinkPython
	51, // 12: model.StreamJobArgs.function:type_name -> model.StreamJobArgs.Function
	...
	27, // 26: model.QueueMessage.property:type_name -> model.StreamJobProperty
	17, // 27: model.DataSource.source_type:type_name -> model.DataSource.Type
	58, // 28: model.DataSource.url:type_name -> datasource.DataSourceURL
	...
	59, // 31: model.TableInfo.table_schema:type_name -> flink.TableSchema
	...
	20, // 35: model.UDFInfo.udf_type:type_name -> model.UDFInfo.Type
	21, // 36: model.UDFInfo.udf_language:type_name -> model.UDFInfo.Language
	52, // 37: model.HostAliases.items:type_name -> model.HostAliases.Item
	22, // 38: model.FlinkCluster.status:type_name -> model.FlinkCluster.Status
	49, // 39: model.FlinkCluster.host_aliases:type_name -> model.HostAliases
	60, // 40: model.FlinkCluster.config:type_name -> flink.FlinkConfig
