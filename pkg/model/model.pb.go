...
type SchInfo struct {
	...
	NotifyStrategies int32 `protobuf:"varint,11,opt,name=notify_strategies,json=notifyStrategies,proto3" json:"notify_strategies,omitempty" gorm:"notify_strategies"`
	// FIXME: Confirm the length of notify group id
	// Notify group id.
	// @inject_tag: gorm:"notify_group"
	NotifyGroup string `protobuf:"bytes,12,opt,name=notify_group,json=notifyGroup,proto3" json:"notify_group,omitempty" gorm:"notify_group"`
	// Timestamp of create time.
	// @inject_tag: gorm:"column:created;autoCreateTime"
...
type NodeInfo struct {
	...
	RetryLimit int32 `protobuf:"varint,6,opt,name=retry_limit,json=retryLimit,proto3" json:"retry_limit,omitempty" gorm:"column:retry_limit"`
	// Interval of Retry, in seconds.
	// @inject_tag: gorm:"column:retry_interval"
	RetryInterval int32 `protobuf:"varint,7,opt,name=retry_interval,json=retryInterval,proto3" json:"retry_interval,omitempty" gorm:"column:retry_interval"`
	...
	// @inject_tag: gorm:"column:failure_strategy;"
	FailureStrategy int32 `protobuf:"varint,9,opt,name=failure_strategy,json=failureStrategy,proto3" json:"failure_strategy,omitempty" gorm:"column:failure_strategy;"`
	...
	Statements string `protobuf:"bytes,12,opt,name=statements,proto3" json:"statements,omitempty" gorm:"column:statements"`
	// Timestamp of create time
	// @inject_tag: gorm:"column:created;autoCreateTime"
	Created int64 `protobuf:"varint,13,opt,name=created,proto3" json:"created,omitempty" gorm:"column:created;autoCreateTime"`
	// Timestamp of update time
...
func (x *NodeInfo) GetStatements() string {
	if x != nil {
		return x.Statements
	}
	return ""
...
var file_proto_model_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x64, 0x22, 0xa8, 0x04, 0x0a, 0x07, 0x53, 0x63, 0x68, 0x49, 0x6e, 0x66, 0x6f,
	...
	,
	...
	,
	...
	,
