...
var _xxx_xxx_Validator_TableInfo_InEnums_Connection = map[DataSourceConnection_Status]bool{0: true, 1: true, 2: true}
...
func (this *TableInfo) _xxx_xxx_Validator_Validate_connection() error {
	...
	if !(_xxx_xxx_Validator_TableInfo_InEnums_Connection[this.Connection]) {
		return protovalidator.FieldError1("TableInfo", "the value of field 'connection' must in enums of '[0 1 2]'", protovalidator.Int32ToString(int32(this.Connection)))
	}
	return nil
}
