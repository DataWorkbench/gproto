...
func (FlinkOperator_Type) EnumDescriptor() ([]byte, []int) {
	return file_proto_flink_proto_rawDescGZIP(), []int{20, 0}
}
...
func (SqlTimeColumnType_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_flink_proto_enumTypes[1].Descriptor()
}

func (SqlTimeColumnType_Type) Type() protoreflect.EnumType {
	return &file_proto_flink_proto_enumTypes[1]
}
...
func (SqlTimeColumnType_Type) EnumDescriptor() ([]byte, []int) {
	return file_proto_flink_proto_rawDescGZIP(), []int{26, 0}
}
...
type FlinkJar struct {
	...
	ResourceId string `protobuf:"bytes,1,opt,name=resource_id,json=resourceId,proto3" json:"resource_id" binding:"gte=20,lte=20" minLength:"20" maxLength:"20"`
	// JarArgs
...
func (*FlinkConfig_Item) Descriptor() ([]byte, []int) {
	return file_proto_flink_proto_rawDescGZIP(), []int{37, 0}
}
...
type FlinkConfig_RestartStrategy struct {
	...
	RestartStrategy string `protobuf:"bytes,1,opt,name=restart_strategy,json=restartStrategy,proto3" json:"restart_strategy" binding:"oneof=none fixed-delay failure-rate"`
	// Affect when restart_strategy == "fixed-delay". Min: 1, Max: 1000. Default 1.
	FixedDelayAttempts int32 `protobuf:"varint,2,opt,name=fixed_delay_attempts,json=fixedDelayAttempts,proto3" json:"fixed_delay_attempts" binding:"gte=1, lte=1000"`
	// Affect when restart_strategy == "fixed-delay". Min: 1, Max: 86400. Default 1, unit is second.
	FixedDelayDelay int32 `protobuf:"varint,3,opt,name=fixed_delay_delay,json=fixedDelayDelay,proto3" json:"fixed_delay_delay binding:"`
	// Affect when restart_strategy == "failure-rate". Min: 1, Max: 1000. Default 1.
	FailureRateMaxFailuresPerInterval int32 `protobuf:"varint,4,opt,name=failure_rate_max_failures_per_interval,json=failureRateMaxFailuresPerInterval,proto3" json:"failure_rate_max_failures_per_interval" binding:"gte=1, lte=1000"`
	// Affect when restart_strategy == "failure-rate". Min: 1, Max: 86400. Default 1. unit is second.
	FailureRateDelay int32 `protobuf:"varint,5,opt,name=failure_rate_delay,json=failureRateDelay,proto3" json:"failure_rate_delay" binding:"gte=1, lte=86400"`
	// Affect when restart_strategy == "failure-rate". Min: 1, Max: 86400. Default 60, unit is second.
	FailureRateFailureRateInterval int32 `protobuf:"varint,6,opt,name=failure_rate_failure_rate_interval,json=failureRateFailureRateInterval,proto3" json:"failure_rate_failure_rate_interval" binding:"gte=1, lte=86400"`
}
...
func (*FlinkConfig_RestartStrategy) Descriptor() ([]byte, []int) {
	return file_proto_flink_proto_rawDescGZIP(), []int{37, 1}
}
...
type FlinkConfig_Logger struct {
	...
	RootLogLevel string `protobuf:"bytes,1,opt,name=root_log_level,json=rootLogLevel,proto3" json:"root_log_level" binding:"TRACE DEBUG INFO WARN ERROR"`
}
...
func (*FlinkConfig_Logger) Descriptor() ([]byte, []int) {
	return file_proto_flink_proto_rawDescGZIP(), []int{37, 2}
}
...
var file_proto_flink_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x49, 0x64, 0x12, 0x2a, 0x0a, 0x08, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x61, 0x73, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0f, 0xe2, 0xdf, 0x1f, 0x0b, 0x12, 0x09, 0xc2, 0x01, 0x06,
	0x90, 0x02, 0x00, 0x98, 0x02, 0x40, 0x52, 0x07, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x41, 0x73, 0x12,
	0x2b, 0x0a, 0x08, 0x64, 0x69, 0x73, 0x74, 0x69, 0x6e, 0x63, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x0f, 0xe2, 0xdf, 0x1f, 0x0b, 0x12, 0x09, 0xc2, 0x01, 0x06, 0x90, 0x02, 0x00, 0x98,
	0x02, 0x40, 0x52, 0x08, 0x64, 0x69, 0x73, 0x74, 0x69, 0x6e, 0x63, 0x74, 0x12, 0x2d, 0x0a, 0x06,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x52, 0x09, 0x73, 0x71, 0x6c, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x12, 0x2f, 0x0a, 0x0c, 0x6d,
	...
	,
	...
	0x2f, 0x0a, 0x0c, 0x6d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0c, 0xe2, 0xdf, 0x1f, 0x08, 0x12, 0x06, 0xc2, 0x01, 0x03,
	0x98, 0x02, 0x40, 0x52, 0x0b, 0x6d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x4e, 0x61, 0x6d, 0x65,
	0x12, 0x49, 0x0a, 0x11, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x5f, 0x6f, 0x70,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x66, 0x6c,
	...
	0x69, 0x6d, 0x65, 0x5f, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b,
	...
	0x04, 0x02, 0x0a, 0x00, 0x22, 0x90, 0x02, 0x0a, 0x0f, 0x43, 0x6c, 0x69, 0x63, 0x6b, 0x48, 0x6f,
	0x75, 0x73, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x39, 0x0a, 0x0a, 0x73, 0x71, 0x6c, 0x5f,
	...
	,
	...
	,
	...
	0x6d, 0x6e, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x66, 0x6c, 0x69, 0x6e, 0x6b,
	...
	,
	...
	0x74, 0x69, 0x6d, 0x65, 0x5f, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x18, 0x05, 0x20, 0x03, 0x28,
	...
	,
	...
	0x6c, 0x75, 0x6d, 0x6e, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x66, 0x6c, 0x69,
	...
	,
	...
	0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x66, 0x6c, 0x69, 0x6e, 0x6b, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_flink_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_proto_flink_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
