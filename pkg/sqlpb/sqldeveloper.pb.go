...
func (x *DAG) Reset() {
	*x = DAG{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_sqldeveloper_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DAG) Descriptor() ([]byte, []int) {
	return file_proto_sqldeveloper_proto_rawDescGZIP(), []int{3}
}
...
func (x *SQL) Reset() {
	*x = SQL{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_sqldeveloper_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SQL) Descriptor() ([]byte, []int) {
	return file_proto_sqldeveloper_proto_rawDescGZIP(), []int{4}
}
...
var file_proto_sqldeveloper_proto_rawDesc = []byte{
	...
	,
	...
	0x67, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x73, 0x71, 0x6c, 0x70, 0x62,
...
var file_proto_sqldeveloper_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_sqldeveloper_proto_goTypes = []interface{}{
	(*EmptyReply)(nil),   // 0: sqlpb.EmptyReply
	(*EmptyRequest)(nil), // 1: sqlpb.EmptyRequest
	(*Relations)(nil),    // 2: sqlpb.Relations
	(*DAG)(nil),          // 3: sqlpb.DAG
	(*SQL)(nil),          // 4: sqlpb.SQL
}
var file_proto_sqldeveloper_proto_depIdxs = []int32{
	3, // 0: sqlpb.Sqldeveloper.DAGToSQL:input_type -> sqlpb.DAG
	4, // 1: sqlpb.Sqldeveloper.SQLToDAG:input_type -> sqlpb.SQL
	1, // 2: sqlpb.Sqldeveloper.NodeRelations:input_type -> sqlpb.EmptyRequest
	4, // 3: sqlpb.Sqldeveloper.DAGToSQL:output_type -> sqlpb.SQL
	3, // 4: sqlpb.Sqldeveloper.SQLToDAG:output_type -> sqlpb.DAG
	2, // 5: sqlpb.Sqldeveloper.NodeRelations:output_type -> sqlpb.Relations
...
func file_proto_sqldeveloper_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_sqldeveloper_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DAG); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_sqldeveloper_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SQL); i {
			case 0:
				return &v.state
			case 1:
