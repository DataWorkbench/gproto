...
var file_proto_response_proto_goTypes = []interface{}{
	...
	(*model.StreamJob)(nil),               // 46: model.StreamJob
	(*model.StreamJobCode)(nil),           // 47: model.StreamJobCode
	(*model.StreamJobArgs)(nil),           // 48: model.StreamJobArgs
	(*model.StreamJobSchedule)(nil),       // 49: model.StreamJobSchedule
	(*model.StreamJobRelease)(nil),        // 50: model.StreamJobRelease
	(*model.MonitorRule)(nil),             // 51: model.MonitorRule
	(*model.StreamJobInst)(nil),           // 52: model.StreamJobInst
...
var file_proto_response_proto_depIdxs = []int32{
	...
	46, // 5: response.ListStreamJobs.infos:type_name -> model.StreamJob
	46, // 6: response.DescribeStreamJob.info:type_name -> model.StreamJob
	47, // 7: response.GetStreamJobCode.code:type_name -> model.StreamJobCode
	48, // 8: response.GetStreamJobArgs.info:type_name -> model.StreamJobArgs
	49, // 9: response.GetStreamJobSchedule.info:type_name -> model.StreamJobSchedule
	50, // 10: response.ListReleaseStreamJobs.infos:type_name -> model.StreamJobRelease
	46, // 11: response.ListStreamJobVersions.infos:type_name -> model.StreamJob
	...
	52, // 14: response.ListStreamInsts.infos:type_name -> model.StreamJobInst
