...
var file_proto_response_proto_goTypes = []interface{}{
	...
	(*model.JobResources)(nil),            // 65: model.JobResources
	(*model.InstanceStatusStat)(nil),      // 66: model.InstanceStatusStat
	(*model.InstanceTaskExecStat)(nil),    // 67: model.InstanceTaskExecStat
	(*model.InstanceRuntimeRankInfo)(nil), // 68: model.InstanceRuntimeRankInfo
	(*model.InstanceErrorRankInfo)(nil),   // 69: model.InstanceErrorRankInfo
	(*model.DispatchTaskCountInfo)(nil),   // 70: model.DispatchTaskCountInfo
	(*model.FlinkCluster)(nil),            // 71: model.FlinkCluster
	(*model.Network)(nil),                 // 72: model.Network
}
var file_proto_response_proto_depIdxs = []int32{
	...
	65, // 24: response.JobParser.Resources:type_name -> model.JobResources
	66, // 25: response.PTasksStatusStat.infos:type_name -> model.InstanceStatusStat
	67, // 26: response.PTasksExecStat.today:type_name -> model.InstanceTaskExecStat
	67, // 27: response.PTasksExecStat.yesterday:type_name -> model.InstanceTaskExecStat
	67, // 28: response.PTasksExecStat.history:type_name -> model.InstanceTaskExecStat
	68, // 29: response.PTaskRuntimeRanking.infos:type_name -> model.InstanceRuntimeRankInfo
	69, // 30: response.PTaskErrorRanking.infos:type_name -> model.InstanceErrorRankInfo
	70, // 31: response.PTaskDispatchCount.infos:type_name -> model.DispatchTaskCountInfo
	71, // 32: response.ListFlinkClusters.infos:type_name -> model.FlinkCluster
	71, // 33: response.DescribeFlinkCluster.info:type_name -> model.FlinkCluster
	72, // 34: response.ListNetworks.infos:type_name -> model.Network
	72, // 35: response.DescribeNetwork.info:type_name -> model.Network
