...
var file_proto_response_proto_rawDesc = []byte{
	...
	0xdf, 0x1f, 0x00, 0x52, 0x05, 0x69, 0x6e, 0x66, 0x6f, 0x73, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69,
...
var file_proto_response_proto_goTypes = []interface{}{
	...
	(*SourceKind_Kind)(nil),               // 39: response.SourceKind.Kind
	(*TableColumns_Column)(nil),           // 40: response.TableColumns.Column
	(*model.Workspace)(nil),               // 41: model.Workspace
	(*model.OpAudit)(nil),                 // 42: model.OpAudit
	(*model.Member)(nil),                  // 43: model.Member
	(*model.Role)(nil),                    // 44: model.Role
	(*model.StreamFlow)(nil),              // 45: model.StreamFlow
	(*model.StreamFlowEnv)(nil),           // 46: model.StreamFlowEnv
	(*model.StreamFlowSchedule)(nil),      // 47: model.StreamFlowSchedule
	(*model.StreamFlowRelease)(nil),       // 48: model.StreamFlowRelease
	(*model.MonitorRule)(nil),             // 49: model.MonitorRule
	(*model.StreamFlowInst)(nil),          // 50: model.StreamFlowInst
	(*model.SourceInfo)(nil),              // 51: model.SourceInfo
	(*model.TableInfo)(nil),               // 52: model.TableInfo
	(*model.Resource)(nil),                // 53: model.Resource
	(*model.UDFInfo)(nil),                 // 54: model.UDFInfo
	(*model.JobResources)(nil),            // 55: model.JobResources
	(*model.HBaseConfig)(nil),             // 56: model.HBaseConfig
	(*model.S3Config)(nil),                // 57: model.S3Config
...
var file_proto_response_proto_depIdxs = []int32{
	41, // 0: response.ListWorkspaces.infos:type_name -> model.Workspace
	42, // 1: response.ListAudits.infos:type_name -> model.OpAudit
	41, // 2: response.DescribeWorkspace.info:type_name -> model.Workspace
	43, // 3: response.ListMembers.infos:type_name -> model.Member
	44, // 4: response.ListSystemRoles.infos:type_name -> model.Role
	45, // 5: response.ListStreamFlows.infos:type_name -> model.StreamFlow
	45, // 6: response.DescribeStreamFlow.info:type_name -> model.StreamFlow
	46, // 7: response.GetStreamFlowEnv.info:type_name -> model.StreamFlowEnv
	47, // 8: response.GetStreamFlowSchedule.info:type_name -> model.StreamFlowSchedule
	48, // 9: response.ListReleaseStreamFlows.infos:type_name -> model.StreamFlowRelease
	45, // 10: response.ListStreamFlowVersions.infos:type_name -> model.StreamFlow
	49, // 11: response.ListMonitorRules.infos:type_name -> model.MonitorRule
	49, // 12: response.DescribeMonitorRule.info:type_name -> model.MonitorRule
	50, // 13: response.ListStreamInsts.infos:type_name -> model.StreamFlowInst
	51, // 14: response.DescribeSource.info:type_name -> model.SourceInfo
	17, // 15: response.ListSource.infos:type_name -> response.DescribeSource
	39, // 16: response.SourceKind.Kinds:type_name -> response.SourceKind.Kind
	40, // 17: response.TableColumns.Columns:type_name -> response.TableColumns.Column
	52, // 18: response.DescribeTable.info:type_name -> model.TableInfo
	52, // 19: response.ListTable.infos:type_name -> model.TableInfo
	53, // 20: response.ListResources.infos:type_name -> model.Resource
	54, // 21: response.ListUDF.infos:type_name -> model.UDFInfo
	54, // 22: response.DescribeUDF.info:type_name -> model.UDFInfo
	55, // 23: response.JobParser.Resources:type_name -> model.JobResources
	56, // 24: response.JobParser.Hbase:type_name -> model.HBaseConfig
	57, // 25: response.JobParser.S3:type_name -> model.S3Config
	58, // 26: response.PTasksStatusStat.infos:type_name -> model.InstanceStatusStat
	59, // 27: response.PTasksExecStat.today:type_name -> model.InstanceTaskExecStat
	59, // 28: response.PTasksExecStat.yesterday:type_name -> model.InstanceTaskExecStat
	59, // 29: response.PTasksExecStat.history:type_name -> model.InstanceTaskExecStat
	60, // 30: response.PTaskRuntimeRanking.infos:type_name -> model.InstanceRuntimeRankInfo
	61, // 31: response.PTaskErrorRanking.infos:type_name -> model.InstanceErrorRankInfo
	62, // 32: response.PTaskDispatchCount.infos:type_name -> model.DispatchTaskCountInfo
